var threatdata = {
    ...
    "mitre": [
        ...
        {
            "procedure_name": "windshield",
            "procedure_code": "s0155",
            "procedure_type": "software",
            "procedure_link": "https://attack.mitre.org/software/S0155",
            "techniques": [
                {
                    "tactic_code": "ta0005",
                    ...
                    "procedure_description": "windshield is capable of file deletion along with other file system interaction.[251]"
                },
                {
                    "tactic_code": "ta0007",
                    ...
                    "procedure_description": "windshield can gather registry values.[103]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "windshield can gather the victim computer name.[196]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "windshield can gather the victim user name.[199]"
                },
                {
                    "tactic_code": "ta0011",
                    ...
                    "procedure_description": "windshield c2 traffic can communicate via tcp raw sockets.[49]"
                }
            ]
        }
    ],
    ...
    "articles": [
        ...
        {
            "data_url": "https://threatvector.cylance.com/en_us/home/report-oceanlotus-apt-group-leveraging-steganography.html",
            "date": "2019-04-02",
            "organization": "Cylance",
            "author": "Cylance Research",
            "title": "Report: OceanLotus APT Group Leveraging Steganography",
            "categories": [
                "Remy"
            ]
        }
