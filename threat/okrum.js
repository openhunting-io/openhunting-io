var threatdata = {
    ...
    "all_data": {
        ...
        "uuid": "cebf5827-f803-4a32-87ab-7a97b8f59102",
    ...
    "mitre": [
        {
            ...
            "procedure_code": "s0439",
            "procedure_type": "software",
            "procedure_link": "https://attack.mitre.org/software/S0439",
            "techniques": [
                {
                    "tactic_code": "ta0002",
                    ...
                    "procedure_description": "okrum's backdoor has used cmd.exe to execute arbitrary commands as well as batch scripts to update itself to a newer version.[246]"
                },
                {
                    "tactic_code": "ta0002",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0002",
                    ...
                    "procedure_description": "okrum's installer can attempt to achieve persistence by creating a scheduled task.[123]"
                },
                {
                    "tactic_code": "ta0002",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0002",
                    ...
                    "procedure_description": "okrum's loader can create a new service named ntmssvc to execute the payload.[41]"
                },
                {
                    "tactic_code": "ta0003",
                    ...
                    "procedure_description": "okrum establishes persistence by creating a .lnk shortcut to itself in the startup folder.[186]"
                },
                {
                    "tactic_code": "ta0003",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0003",
                    ...
                    "procedure_description": "okrum can establish persistence by creating a .lnk shortcut to itself in the startup folder.[25]"
                },
                {
                    "tactic_code": "ta0003",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0003",
                    ...
                    "procedure_description": "to establish persistence, okrum can install itself as a new service named ntmssvc.[83]"
                },
                {
                    "tactic_code": "ta0003",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0003",
                ...
                },
                {
                    ...
                    "procedure_description": "okrum can impersonate a logged-on user's security context using a call to the impersonateloggedonuser api.[9]"
                },
                {
                    "tactic_code": "ta0004",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0004",
                ...
                },
                {
                    ...
                    "procedure_description": "okrum's loader can decrypt the backdoor code, embedded within the loader or within a legitimate png file. a custom xor cipher or rc4 is used for decryption.[162]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                    ...
                    "procedure_description": "before exfiltration, okrum's backdoor has used hidden files to store logs and outputs from backdoor commands.[35]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                    ...
                    "procedure_description": "okrum's backdoor deletes files after they have been successfully uploaded to c2 servers.[164]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                    ...
                    "procedure_description": "okrum can establish persistence by adding a new service ntmssvc with the display name removable storage to masquerade as a legitimate removable storage manager.[52]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                    ...
                    "procedure_description": "okrum's payload is encrypted and embedded within its loader, or within a legitimate png file.[17]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                    ...
                    "procedure_description": "okrum's loader can check the amount of physical memory and terminates itself if the host has less than 1.5 gigabytes of physical memory in total.[35]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                    ...
                    "procedure_description": "okrum loader only executes the payload after the left mouse button has been pressed at least three times, in order to avoid being executed within virtualized or emulated environments.[6]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                    ...
                    "procedure_description": "okrum's loader can detect presence of an emulator by using two calls to gettickcount api, and checking whether the time has been accelerated.[31]"
                },
                {
                    "tactic_code": "ta0006",
                    ...
                    "procedure_description": "okrum was seen using a keylogger tool to capture keystrokes. [131]"
                },
                {
                    "tactic_code": "ta0006",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0006",
                    ...
                    "procedure_description": "okrum was seen using mimikatzlite to perform credential dumping.[68]"
                },
                {
                    "tactic_code": "ta0006",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0006",
                    ...
                    "procedure_description": "okrum was seen using modified quarks pwdump to perform credential dumping.[15]"
                },
                {
                    "tactic_code": "ta0007",
                    ...
                    "procedure_description": "okrum has used driveletterview to enumerate drive information.[214]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "okrum can collect computer name, locale information, and information about the os and architecture.[261]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "okrum can collect network information, including the host ip address, dns, and proxy information.[164]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "okrum was seen using netsess to discover netbios sessions.[60]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "okrum can collect the victim username.[136]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "okrum can obtain the date and time of the compromised system.[54]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                ...
                },
                {
                    ...
                    "procedure_description": "okrum was seen using a rar archiver tool to compress/decompress data.[52]"
                },
                {
                    "tactic_code": "ta0009",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0009",
                    ...
                    "procedure_description": "okrum has used a custom implementation of aes encryption to encrypt collected data.[26]"
                },
                {
                    "tactic_code": "ta0009",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0009",
                ...
                },
                {
                    ...
                    "procedure_description": "okrum uses http for communication with its c2.[233]"
                },
                {
                    "tactic_code": "ta0011",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0011",
                    ...
                    "procedure_description": "okrum has used base64 to encode c2 communication.[62]"
                },
                {
                    "tactic_code": "ta0011",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0011",
                    ...
                    "procedure_description": "okrum mimics http protocol for c2 communication, while hiding the actual messages in the cookie and set-cookie headers of the http requests.[16]"
                },
                {
                    "tactic_code": "ta0011",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0011",
                    ...
                    "procedure_description": "okrum uses aes to encrypt network traffic. the key can be hardcoded or negotiated with the c2 server in the registration phase. [100]"
                },
                {
                    "tactic_code": "ta0011",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0011",
                    ...
                    "procedure_description": "okrum has built-in commands for uploading, downloading, and executing files to the system.[325]"
                },
                {
                    "tactic_code": "ta0011",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0011",
                    ...
                    "procedure_description": "okrum can identify proxy servers configured and used by the victim, and use it to make http requests to c2 its server.[19]"
                },
                {
                    "tactic_code": "ta0010",
