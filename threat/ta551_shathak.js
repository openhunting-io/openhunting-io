var threatdata = {
    ...
    "file_name": "ta551_shathak",
    "analysis": null,
    "articles": [],
    "mitre": [
        {
            "procedure_name": "ta551",
            "procedure_code": "g0127",
            "procedure_type": "apt-group",
            "procedure_link": "https://attack.mitre.org/groups/G0127",
            "techniques": [
                {
                    "tactic_code": "ta0043",
                    ...
                    "procedure_description": "ta551 has used spoofed company emails that were acquired from email clients on previously infected hosts to target other individuals.[21]"
                },
                {
                    "tactic_code": "ta0001",
                    ...
                    "procedure_description": "ta551 has sent spearphishing attachments with password protected zip files.[222][223][224]"
                },
                {
                    "tactic_code": "ta0002",
                    ...
                    "procedure_description": "ta551 has used cmd.exe to execute commands.[322]"
                },
                {
                    "tactic_code": "ta0002",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0002",
                    ...
                    "procedure_description": "ta551 has prompted users to enable macros within spearphishing attachments to install malware.[235]"
                },
                {
                    "tactic_code": "ta0005",
                    ...
                    "procedure_description": "ta551 has masked malware dlls as dat and jpg files.[40]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                    ...
                    "procedure_description": "ta551 has hidden encoded data for malware dlls in a png.[24]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                    ...
                    "procedure_description": "ta551 has used obfuscated variable names in a javascript configuration file.[84]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                    ...
                    "procedure_description": "ta551 has used mshta.exe to execute malicious payloads.[35]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                    ...
                    "procedure_description": "ta551 has used regsvr32.exe to load malicious dlls.[40]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                    ...
                    "procedure_description": "ta551 has used rundll32.exe to load malicious dlls.[98]"
                },
                {
                    "tactic_code": "ta0011",
                    ...
                    "procedure_description": "ta551 has used http for c2 communications.[330]"
                },
                {
                    "tactic_code": "ta0011",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0011",
                    ...
                    "procedure_description": "ta551 has used encoded ascii text for initial c2 communications.[91]"
                },
                {
                    "tactic_code": "ta0011",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0011",
                    ...
                    "procedure_description": "ta551 has used a dga to generate urls from executed macros.[29][30]"
                },
                {
                    "tactic_code": "ta0011",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0011",
                    ...
                    "procedure_description": "ta551 has retrieved dlls and installer binaries for malware execution from c2.[435]"
                }
            ]
        },
        {
