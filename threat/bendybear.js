var threatdata = {
    ...
    "mitre": [
        {
            "procedure_name": "bendybear",
            "procedure_code": "s0574",
            "procedure_type": "software",
            "procedure_link": "https://attack.mitre.org/software/S0574",
            "techniques": [
                {
                    "tactic_code": "ta0002",
                    ...
                    "procedure_description": "bendybear can load and execute modules and windows application programming (api) calls using standard shellcode api hashing.[35]"
                },
                {
                    "tactic_code": "ta0005",
                    ...
                    "procedure_description": "bendybear has decrypted function blocks using a xor key during runtime to evade detection.[32]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                    ...
                    "procedure_description": "bendybear has encrypted payloads using rc4 and xor.[49]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                    ...
                    "procedure_description": "bendybear can check for analysis environments and signs of debugging using the windows api kernel32!gettickcountkernel32 call.[10]"
                },
                {
                    "tactic_code": "ta0007",
                    ...
                    "procedure_description": "bendybear can query the host's registry key at hkey_current_user\\console\\quickedit to retrieve data.[13]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "bendybear has the ability to determine local time on a compromised host.[14]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                ...
                },
                {
                    ...
                    "procedure_description": "bendybear has used byte randomization to obscure its behavior.[2]"
                },
                {
                    "tactic_code": "ta0011",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0011",
                    ...
                    "procedure_description": "bendybear communicates to a c2 server over port 443 using modified rc4 and xor-encrypted chunks.[14]"
                },
                {
                    "tactic_code": "ta0011",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0011",
                    ...
                    "procedure_description": "bendybear is designed to download an implant from a c2 server.[62]"
                },
                {
                    "tactic_code": "ta0011",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0011",
                    ...
                    "procedure_description": "bendybear has used a custom rc4 and xor encrypted protocol over port 443 for c2.[8]"
                }
            ]
        }
    ],
