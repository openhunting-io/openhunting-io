    ...
    "mitre": [
        {
            ...
            "procedure_code": "s1031",
            "procedure_type": "software",
            "procedure_link": "https://attack.mitre.org/software/S1031",
            "techniques": [
                {
                    "tactic_code": "ta0002",
                    ...
                    "procedure_description": "pingpull can use cmd.exe to run various commands as a reverse shell.[258]"
                },
                {
                    "tactic_code": "ta0003",
                    ...
                    "procedure_description": "pingpull has the ability to install itself as a service.[87]"
                },
                {
                    "tactic_code": "ta0004",
                ...
                },
                {
                    ...
                    "procedure_description": "pingpull can decrypt received data from its c2 server by using aes.[170]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                    ...
                    "procedure_description": "pingpull has the ability to timestomp a file.[42]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                    ...
                    "procedure_description": "pingpull can mimic the names and descriptions of legitimate services such as iphlpsvc, ip helper,  and onedrive to evade detection.[54]"
                },
                {
                    "tactic_code": "ta0007",
                    ...
                    "procedure_description": "pingpull can enumerate storage volumes and folder contents of a compromised host.[227]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "pingpull can retrieve the hostname of a compromised host.[275]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "pingpull can retrieve the ip address of a compromised host.[172]"
                },
                {
                    "tactic_code": "ta0009",
                    ...
                    "procedure_description": "pingpull can collect data from a compromised host.[140]"
                },
                {
                    "tactic_code": "ta0011",
                    ...
                    "procedure_description": "a pingpull variant can communicate with its c2 servers by using https.[244]"
                },
                {
                    "tactic_code": "ta0011",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0011",
                    ...
                    "procedure_description": "pingpull can encode c2 traffic with base64.[65]"
                },
                {
                    "tactic_code": "ta0011",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0011",
                    ...
                    "procedure_description": "pingpull can use aes, in cipher block chaining (cbc) mode padded with pkcs5, to encrypt c2 server communications.[103]"
                },
                {
                    "tactic_code": "ta0011",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0011",
                    ...
                    "procedure_description": "pingpull variants have the ability to communicate with c2 servers using icmp or tcp.[50]"
                },
                {
                    "tactic_code": "ta0011",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0011",
                    ...
                    "procedure_description": "pingpull can use https over port 8080 for c2.[28]"
                },
                {
                    "tactic_code": "ta0010",
                    ...
                    "procedure_description": "pingpull has the ability to exfiltrate stolen victim data through its c2 channel.[99]"
                }
            ]
        },
        {
