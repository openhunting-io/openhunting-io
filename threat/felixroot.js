var threatdata = {
    "name": "Felixroot",
    "alias": "Felixroot, GreyEnergy mini",
    "category": "Malware",
    "type": "Backdoor",
    "modified": "2021-09-06",
    "all_data": {
        ...
        "alienvault-otx": [
            "https://otx.alienvault.com/browse/pulses?q=tag:FELIXROOT"
        ],
        "uuid": "ebbfbe19-e146-4df3-8d7d-19cd716a94bd",
    ...
    "mitre": [
        {
            ...
            "procedure_code": "s0267",
            "procedure_type": "software",
            "procedure_link": "https://attack.mitre.org/software/S0267",
            "techniques": [
                {
                    "tactic_code": "ta0002",
                    ...
                    "procedure_description": "felixroot executes batch scripts on the victim\u2019s machine, and can launch a reverse shell for command execution.[120][121]"
                },
                {
                    "tactic_code": "ta0002",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0002",
                    ...
                    "procedure_description": "felixroot uses wmi to query the windows registry.[43]"
                },
                {
                    "tactic_code": "ta0003",
                    ...
                    "procedure_description": "felixroot adds a shortcut file to the startup folder for persistence.[89]"
                },
                {
                    "tactic_code": "ta0003",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0003",
                    ...
                    "procedure_description": "felixroot creates a .lnk file for persistence.[11]"
                },
                {
                    "tactic_code": "ta0004",
                ...
                },
                {
                    ...
                    "procedure_description": "felixroot deletes the .lnk file from the startup directory as well as the dropper components.[69]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                    ...
                    "procedure_description": "felixroot deletes the registry key hkcu\\software\\classes\\applications\\rundll32.exe\\shell\\open.[57]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                    ...
                    "procedure_description": "felixroot encrypts strings in the backdoor using a custom xor algorithm.[121][122]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                    ...
                    "procedure_description": "felixroot uses rundll32 for executing the dropper program.[44][45]"
                },
                {
                    "tactic_code": "ta0007",
                    ...
                    "procedure_description": "felixroot collects a list of running processes.[100]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "felixroot queries the registry for specific keys for potential privilege escalation and proxy information. felixroot has also used wmi to query the windows registry.[39][40]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "felixroot checks for installed security software like antivirus and firewall.[37]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "felixroot collects the victim\u2019s computer name, processor architecture, os version, volume serial number, and system type.[133][134]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "felixroot collects information about the network including the ip address and dhcp server.[88]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "felixroot collects the username from the victim\u2019s machine.[63][64]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "felixroot gathers the time zone information from the victim\u2019s machine.[36]"
                },
                {
                    "tactic_code": "ta0009",
                    ...
                    "procedure_description": "felixroot encrypts collected data with aes and base64 and then sends it to the c2 server.[23]"
                },
                {
                    "tactic_code": "ta0011",
                    ...
                    "procedure_description": "felixroot uses http and https to communicate with the c2 server.[122][123]"
                },
                {
                    "tactic_code": "ta0011",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0011",
                    ...
                    "procedure_description": "felixroot downloads and uploads files to and from the victim\u2019s machine.[175][176]"
                }
            ]
        },
        {
