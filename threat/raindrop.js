var threatdata = {
    ...
    "alias": "RAINDROP",
    "category": "Malware",
    "type": "Backdoor, Dropper, Loader, Remote command",
    "modified": "2022-12-30",
    "all_data": {
        "tool": "RAINDROP",
        "names": [
        ...
        "uuid": "122be2b4-0bc3-41f3-8154-b21db01f7a01",
    ...
    "mitre": [
        {
            "procedure_name": "raindrop",
            "procedure_code": "s0565",
            "procedure_type": "software",
            "procedure_link": "https://attack.mitre.org/software/S0565",
            "techniques": [
                {
                    "tactic_code": "ta0005",
                    ...
                    "procedure_description": "raindrop decrypted its cobalt strike payload using an aes-256 encryption algorithm in cbc mode with a unique key per sample.[185][186]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                    ...
                    "procedure_description": "raindrop was built to include a modified version of 7-zip source code (including associated export names) and far manager source code.[29][30]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                    ...
                    "procedure_description": "raindrop was installed under names that resembled legitimate windows file and directory names.[134][135]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                    ...
                    "procedure_description": "raindrop encrypted its payload using a simple xor algorithm with a single-byte key.[263][264]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                    ...
                    "procedure_description": "raindrop used a custom packer for its cobalt strike payload, which was compressed using the lzma algorithm.[69][70]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                    ...
                    "procedure_description": "raindrop used steganography to locate the start of its encoded payload within legitimate 7-zip code.[21]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                    ...
                    "procedure_description": "after initial installation, raindrop runs a computation to delay execution.[36]"
                },
                {
                    "tactic_code": "ta0007",
