var threatdata = {
    "name": "KGH_SPY",
    "alias": "KGH_SPY, KGH Spyware Suite",
    "category": "Malware",
    ...
    "all_data": {
        ...
        "uuid": "1603714e-0992-4188-bbc9-5a506daf83e7",
    ...
    "mitre": [
        {
            ...
            "procedure_code": "s0526",
            "procedure_type": "software",
            "procedure_link": "https://attack.mitre.org/software/S0526",
            "techniques": [
                {
                    "tactic_code": "ta0002",
                    ...
                    "procedure_description": "kgh_spy can execute powershell commands on the victim's machine.[125]"
                },
                {
                    "tactic_code": "ta0002",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0002",
                    ...
                    "procedure_description": "kgh_spy has the ability to set a registry key to run a cmd.exe command.[177]"
                },
                {
                    "tactic_code": "ta0002",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0002",
                    ...
                    "procedure_description": "kgh_spy has been spread through word documents containing malicious macros.[63]"
                },
                {
                    "tactic_code": "ta0003",
                    ...
                    "procedure_description": "kgh_spy has the ability to set the hkcu\\environment\\userinitmprlogonscript registry key to execute logon scripts.[8]"
                },
                {
                    "tactic_code": "ta0004",
                ...
                },
                {
                    ...
                    "procedure_description": "kgh_spy can decrypt encrypted strings and write them to a newly created folder.[124]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                    ...
                    "procedure_description": "kgh_spy has masqueraded as a legitimate windows tool.[80]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                    ...
                    "procedure_description": "kgh_spy has used encrypted strings in its installer.[183]"
                },
                {
                    "tactic_code": "ta0006",
                    ...
                    "procedure_description": "kgh_spy can collect credentials from winscp.[11]"
                },
                {
                    "tactic_code": "ta0006",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0006",
                    ...
                    "procedure_description": "kgh_spy has the ability to steal data from the chrome, edge, firefox, thunderbird, and opera browsers.[37]"
                },
                {
                    "tactic_code": "ta0006",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0006",
                    ...
                    "procedure_description": "kgh_spy can collect credentials from the windows credential manager.[7]"
                },
                {
                    "tactic_code": "ta0006",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0006",
                    ...
                    "procedure_description": "kgh_spy can perform keylogging by polling the getasynckeystate() function.[90]"
                },
                {
                    "tactic_code": "ta0007",
                    ...
                    "procedure_description": "kgh_spy can enumerate files and directories on a compromised host.[164]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "kgh_spy can collect information on installed applications.[15]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "kgh_spy can collect drive information from a compromised host.[190]"
                },
                {
                    "tactic_code": "ta0009",
                    ...
                    "procedure_description": "kgh_spy can send a file containing victim system information to c2.[95]"
                },
                {
                    "tactic_code": "ta0009",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0009",
                    ...
                    "procedure_description": "kgh_spy can save collected system information to a file named \"info\" before exfiltration.[44]"
                },
                {
                    "tactic_code": "ta0009",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0009",
                    ...
                    "procedure_description": "kgh_spy can harvest data from mail clients.[10]"
                },
                {
                    "tactic_code": "ta0009",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0009",
                ...
                },
                {
                    ...
                    "procedure_description": "kgh_spy can send data to c2 with http post requests.[85]"
                },
                {
                    "tactic_code": "ta0011",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0011",
                    ...
                    "procedure_description": "kgh_spy has the ability to download and execute code from remote servers.[130]"
                },
                {
                    "tactic_code": "ta0010",
