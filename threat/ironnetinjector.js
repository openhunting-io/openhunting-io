    ...
    "mitre": [
        {
            ...
            "procedure_code": "s0581",
            "procedure_type": "software",
            "procedure_link": "https://attack.mitre.org/software/S0581",
            "techniques": [
                {
                    "tactic_code": "ta0002",
                    ...
                    "procedure_description": "ironnetinjector can use ironpython scripts to load payloads with the help of a .net injector.[20]"
                },
                {
                    "tactic_code": "ta0002",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0002",
                    ...
                    "procedure_description": "ironnetinjector has used a task xml file named mssch.xml to run an ironpython script when a user logs in or when specific system events are created.[85]"
                },
                {
                    "tactic_code": "ta0003",
                ...
                },
                {
                    ...
                    "procedure_description": "ironnetinjector can use an ironpython scripts to load a .net injector to inject a payload into its own or a remote process.[31]"
                },
                {
                    "tactic_code": "ta0004",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0004",
                    ...
                    "procedure_description": "ironnetinjector has the ability to inject a dll into running processes, including the ironnetinjector dll into explorer.exe.[36]"
                },
                {
                    "tactic_code": "ta0004",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0004",
                ...
                },
                {
                    ...
                    "procedure_description": "ironnetinjector has the ability to decrypt embedded .net and pe payloads.[119]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                    ...
                    "procedure_description": "ironnetinjector has been disguised as a legitimate service using the name pythonupdatesrvc.[39]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                    ...
                    "procedure_description": "ironnetinjector can obfuscate variable names, encrypt strings, as well as base64 encode and rijndael encrypt payloads.[170]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                ...
                },
                {
                    ...
                    "procedure_description": "ironnetinjector can identify processes via c# methods such as getprocessesbyname and running tasklist with the python os.popen function.[133]"
                }
            ]
        },
        {
