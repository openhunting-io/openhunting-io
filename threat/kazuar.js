var threatdata = {
    ...
    "all_data": {
        ...
        "uuid": "65bcba1a-e845-438b-9920-72bf6282af32",
        "last-card-change": "2021-01-05",
    ...
    "mitre": [
        {
            ...
            "procedure_code": "s0265",
            "procedure_type": "software",
            "procedure_link": "https://attack.mitre.org/software/S0265",
            "techniques": [
                {
                    "tactic_code": "ta0002",
                    ...
                    "procedure_description": "kazuar uses cmd.exe to execute commands on the victim\u2019s machine.[171]"
                },
                {
                    "tactic_code": "ta0002",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0002",
                    ...
                    "procedure_description": "kazuar uses /bin/bash to execute commands on the victim\u2019s machine.[22]"
                },
                {
                    "tactic_code": "ta0002",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0002",
                    ...
                    "procedure_description": "kazuar obtains a list of running processes through wmi querying.[63]"
                },
                {
                    "tactic_code": "ta0003",
                    ...
                    "procedure_description": "kazuar adds a sub-key under several registry run keys.[130]"
                },
                {
                    "tactic_code": "ta0003",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0003",
                    ...
                    "procedure_description": "kazuar adds a .lnk file to the windows startup folder.[18]"
                },
                {
                    "tactic_code": "ta0003",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0003",
                    ...
                    "procedure_description": "kazuar can install itself as a new service.[68]"
                },
                {
                    "tactic_code": "ta0004",
                ...
                },
                {
                    ...
                    "procedure_description": "if running in a windows environment, kazuar saves a dll to disk that is injected into the explorer.exe process to execute the payload. kazuar can also be configured to inject and execute within specific processes.[37]"
                },
                {
                    "tactic_code": "ta0005",
                    ...
                    "procedure_description": "kazuar can delete files.[118]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                    ...
                    "procedure_description": "kazuar is obfuscated using the open source confuserex protector. kazuar also obfuscates the name of created files/folders/mutexes and encrypts debug messages written to log files using the rijndael cipher.[177]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                ...
                },
                {
                    ...
                    "procedure_description": "kazuar gathers information on local groups and members on the victim\u2019s machine.[20]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "kazuar gathers information about opened windows.[14]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "kazuar finds a specified directory, lists the files and metadata about those files.[159]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "kazuar gathers information about local groups and members.[15]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "kazuar obtains a list of running processes through wmi querying and the ps command.[141]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "kazuar gathers information on the system and local drives.[182]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "kazuar gathers information about network adapters.[115]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "kazuar gathers information on users.[86]"
                },
                {
                    "tactic_code": "ta0009",
                    ...
                    "procedure_description": "kazuar uploads files from a specified directory to the c2 server.[91]"
                },
                {
                    "tactic_code": "ta0009",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0009",
                    ...
                    "procedure_description": "kazuar stages command output and collected data in files before exfiltration.[43]"
                },
                {
                    "tactic_code": "ta0009",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0009",
                    ...
                    "procedure_description": "kazuar captures screenshots of the victim\u2019s screen.[85]"
                },
                {
                    "tactic_code": "ta0009",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0009",
                    ...
                    "procedure_description": "kazuar captures images from the webcam.[24]"
                },
                {
                    "tactic_code": "ta0011",
                    ...
                    "procedure_description": "kazuar uses http and https to communicate with the c2 server. kazuar can also act as a webserver and listen for inbound http requests through an exposed api.[173]"
                },
                {
                    "tactic_code": "ta0011",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0011",
                    ...
                    "procedure_description": "kazuar uses ftp and ftps to communicate with the c2 server.[5]"
                },
                {
                    "tactic_code": "ta0011",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0011",
                    ...
                    "procedure_description": "kazuar encodes communications to the c2 server in base64.[46]"
                },
                {
                    "tactic_code": "ta0011",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0011",
                    ...
                    "procedure_description": "kazuar can accept multiple urls for c2 servers.[24]"
                },
                {
                    "tactic_code": "ta0011",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0011",
                    ...
                    "procedure_description": "kazuar downloads additional plug-ins to load on the victim\u2019s machine, including the ability to upgrade and replace its own binary.[238]"
                },
                {
                    "tactic_code": "ta0011",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0011",
                    ...
                    "procedure_description": "kazuar has used internal nodes on the compromised network for c2 communications.[14]"
                },
                {
                    "tactic_code": "ta0011",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0011",
                    ...
                    "procedure_description": "kazuar has used compromised wordpress blogs as c2 servers.[31]"
                },
                {
                    "tactic_code": "ta0010",
                    ...
                    "procedure_description": "kazuar can sleep for a specific time and be set to communicate at specific intervals.[9]"
                },
                {
                    "tactic_code": "ta0040",
