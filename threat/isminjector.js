var threatdata = {
    "name": "ISMInjector",
    "alias": "ISMInjector, Agent Injector",
    "category": "Malware",
    "type": "Loader",
    "modified": "2020-04-22",
    "all_data": {
        ...
        "uuid": "323162c2-b731-4641-8797-5870730ddb32",
    ...
    "mitre": [
        {
            "procedure_name": "isminjector",
            "procedure_code": "s0189",
            "procedure_type": "software",
            "procedure_link": "https://attack.mitre.org/software/S0189",
            "techniques": [
                {
                    "tactic_code": "ta0002",
                    ...
                    "procedure_description": "isminjector creates scheduled tasks to establish persistence.[86]"
                },
                {
                    "tactic_code": "ta0003",
                ...
                },
                {
                    ...
                    "procedure_description": "isminjector hollows out a newly created process regasm.exe and injects its payload into the hollowed process.[22]"
                },
                {
                    "tactic_code": "ta0004",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0004",
                ...
                },
                {
                    ...
                    "procedure_description": "isminjector uses the certutil command to decode a payload file.[120]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                    ...
                    "procedure_description": "isminjector is obfuscated with the off-the-shelf smartassembly .net obfuscator created by red-gate.com.[171]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
