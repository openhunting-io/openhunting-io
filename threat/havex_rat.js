var threatdata = {
    ...
    "mitre": [
        ...
        {
            "procedure_name": "backdoor.oldrea",
            "procedure_code": "s0093",
            "procedure_type": "software",
            "procedure_link": "https://attack.mitre.org/software/S0093",
            "techniques": [
                {
                    "tactic_code": "ta0003",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0003",
                    ...
                    "procedure_description": "backdoor.oldrea adds registry run keys to achieve persistence.[37][38]"
                },
                {
                    "tactic_code": "ta0004",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0004",
                ...
                },
                {
                    ...
                    "procedure_description": "backdoor.oldrea injects itself into explorer.exe.[8][9]"
                },
                {
                    "tactic_code": "ta0005",
                    ...
                    "procedure_description": "backdoor.oldrea contains a cleanup module that removes traces of itself from the victim.[22]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                ...
                },
                {
                    ...
                    "procedure_description": "backdoor.oldrea can use rundll32 for execution on compromised hosts.[18]"
                },
                {
                    "tactic_code": "ta0006",
                    ...
                    "procedure_description": "some backdoor.oldrea samples contain a publicly available web browser password recovery tool.[13]"
                },
                {
                    "tactic_code": "ta0007",
                    ...
                    "procedure_description": "backdoor.oldrea collects address book information from outlook.[5]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "backdoor.oldrea collects information about available drives, default browser, desktop file list, my documents, internet history, program files, and root of available drives. it also searches for ics-related software files.[33]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "backdoor.oldrea can use a network scanning module to identify ics-related ports.[8]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "backdoor.oldrea collects information about running processes.[25]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "backdoor.oldrea can enumerate and map ics-specific systems in victim environments.[16]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "backdoor.oldrea collects information about the os and computer name.[42][43]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "backdoor.oldrea collects information about the internet adapter configuration.[28][29]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "backdoor.oldrea collects the current username from the victim.[21]"
                },
                {
                    "tactic_code": "ta0009",
                    ...
                    "procedure_description": "backdoor.oldrea writes collected data to a temporary file in an encrypted form before exfiltration to a c2 server.[8]"
                },
                {
                    "tactic_code": "ta0011",
                    ...
                    "procedure_description": "some backdoor.oldrea samples use standard base64 + bzip2, and some use standard base64 + reverse xor + rsa-2048 to decrypt data received from c2 servers.[9]"
                },
                {
                    "tactic_code": "ta0011",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0011",
