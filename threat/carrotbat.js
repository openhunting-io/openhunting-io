var threatdata = {
    ...
    "all_data": {
        ...
        "alienvault-otx": [
            "https://otx.alienvault.com/browse/pulses?q=tag:carrotbat"
        ],
        "uuid": "93c8b066-2a8d-4ca9-8e0d-ae83cead5b1f",
    ...
    "mitre": [
        {
            ...
            "procedure_code": "s0462",
            "procedure_type": "software",
            "procedure_link": "https://attack.mitre.org/software/S0462",
            "techniques": [
                {
                    "tactic_code": "ta0002",
                    ...
                    "procedure_description": "carrotbat has the ability to execute command line arguments on a compromised host.[63]"
                },
                {
                    "tactic_code": "ta0005",
                    ...
                    "procedure_description": "carrotbat has the ability to delete downloaded files from a compromised host.[38]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                    ...
                    "procedure_description": "carrotbat has the ability to download a base64 encoded payload.[75]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                    ...
                    "procedure_description": "carrotbat has the ability to execute obfuscated commands on the infected host.[21]"
                },
                {
                    "tactic_code": "ta0007",
                    ...
                    "procedure_description": "carrotbat has the ability to determine the operating system of the compromised host and whether windows is being run with x86 or x64 architecture.[81][82]"
                },
                {
                    "tactic_code": "ta0011",
                    ...
                    "procedure_description": "carrotbat has the ability to download and execute a remote file via certutil.[97]"
                }
            ]
        },
        {
