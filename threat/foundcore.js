var threatdata = {
    ...
    "all_data": {
        ...
        "uuid": "fd134b1c-5367-4606-a171-2ab6a45ef77f",
    ...
    "mitre": [
        {
            "procedure_name": "rainyday",
            "procedure_code": "s0629",
            "procedure_type": "software",
            "procedure_link": "https://attack.mitre.org/software/S0629",
            "techniques": [
                {
                    "tactic_code": "ta0002",
                    ...
                    "procedure_description": "rainyday can use the windows command shell for execution.[233]"
                },
                {
                    "tactic_code": "ta0002",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0002",
                    ...
                    "procedure_description": "the file collection tool used by rainyday can utilize native api including readdirectorychangew for folder monitoring.[126]"
                },
                {
                    "tactic_code": "ta0002",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0002",
                    ...
                    "procedure_description": "rainyday can use scheduled tasks to achieve persistence.[116]"
                },
                {
                    "tactic_code": "ta0003",
                    ...
                    "procedure_description": "rainyday can use services to establish persistence.[80]"
                },
                {
                    "tactic_code": "ta0003",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0003",
                    ...
                    "procedure_description": "rainyday can use side-loading to run malicious executables.[48]"
                },
                {
                    "tactic_code": "ta0003",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0003",
                ...
                },
                {
                    ...
                    "procedure_description": "rainyday can decrypt its payload via a xor key.[187]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                ...
                },
                {
                    ...
                    "procedure_description": "rainyday has the ability to uninstall itself by deleting its service and files.[157]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                    ...
                    "procedure_description": "rainyday has named services and scheduled tasks to appear benign including \"chromecheck\" and \"googleupdate.\"[49]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                    ...
                    "procedure_description": "rainyday has used names to mimic legitimate software including \"vmtoolsd.exe\" to spoof vmtools.[106]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                    ...
                    "procedure_description": "rainyday has downloaded as a xor-encrypted payload.[265]"
                },
                {
                    "tactic_code": "ta0006",
                    ...
                    "procedure_description": "rainyday can use tools to collect credentials from web browsers.[77]"
                },
                {
                    "tactic_code": "ta0006",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0006",
                    ...
                    "procedure_description": "rainyday can use the quarkspwdump tool to obtain local passwords and domain cached credentials.[13]"
                },
                {
                    "tactic_code": "ta0007",
                    ...
                    "procedure_description": "rainyday can use a file exfiltration tool to collect recently changed files with specific extensions.[204]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "rainyday can enumerate processes on a target system.[180]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "rainyday can create and register a service for execution.[43]"
                },
                {
                    "tactic_code": "ta0009",
                    ...
                    "procedure_description": "rainyday can use a file exfiltration tool to collect recently changed files on a compromised host.[124]"
                },
                {
                    "tactic_code": "ta0009",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0009",
                    ...
                    "procedure_description": "rainyday can use a file exfiltration tool to copy files to c:\\programdata\\adobe\\temp prior to exfiltration.[82]"
                },
                {
                    "tactic_code": "ta0009",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0009",
                    ...
                    "procedure_description": "rainyday has the ability to capture screenshots.[133]"
                },
                {
                    "tactic_code": "ta0011",
                    ...
                    "procedure_description": "rainyday can use http in c2 communications.[265]"
                },
                {
                    "tactic_code": "ta0011",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0011",
                    ...
                    "procedure_description": "rainyday can use rc4 to encrypt c2 communications.[97]"
                },
                {
                    "tactic_code": "ta0011",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0011",
                    ...
                    "procedure_description": "rainyday has the ability to switch between tcp and http for c2 if one method is not working.[39]"
                },
                {
                    "tactic_code": "ta0011",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0011",
                    ...
                    "procedure_description": "rainyday can download files to a compromised host.[312]"
                },
                {
                    "tactic_code": "ta0011",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0011",
                    ...
                    "procedure_description": "rainyday can use tcp in c2 communications.[41]"
                },
                {
                    "tactic_code": "ta0011",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0011",
                    ...
                    "procedure_description": "rainyday can use proxy tools including boost_proxy_client for reverse proxy functionality.[39]"
                },
                {
                    "tactic_code": "ta0010",
                    ...
                    "procedure_description": "rainyday can use a file exfiltration tool to upload specific files to dropbox.[22]"
                }
            ]
        }
    ],
