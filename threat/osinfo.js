var threatdata = {
    ...
    "all_data": {
        ...
        "description": "(Symantec) OSInfo is a general purpose, system information gathering tool.",
        "category": "Tools",
        "type": [
            "Reconnaissance"
        ],
        ...
        "uuid": "df27d498-e88a-45d3-a55b-bb0a7891814b",
    ...
    "mitre": [
        {
            "procedure_name": "osinfo",
            "procedure_code": "s0165",
            "procedure_type": "software",
            "procedure_link": "https://attack.mitre.org/software/S0165",
            "techniques": [
                {
                    "tactic_code": "ta0007",
                    ...
                    "procedure_description": "osinfo enumerates local and domain users[4]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "osinfo enumerates local and domain users[37]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "osinfo discovers shares on the network[42]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "osinfo has enumerated the local administrators group.[21]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "osinfo specifically looks for domain admins and power users within the domain.[23]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "osinfo queries the registry to look for information about terminal services.[65]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "osinfo performs a connection test to discover remote systems in the network[8]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "osinfo discovers information about the infected machine.[23]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "osinfo discovers the current domain information.[16]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "osinfo enumerates the current network connections similar to  net use .[8]"
                }
            ]
        }
    ],
