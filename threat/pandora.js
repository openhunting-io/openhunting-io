var threatdata = {
    ...
    "all_data": {
        ...
        "description": "Pandora ransomware was obtained by vx-underground at 2022-03-14.",
        "category": "Malware",
        "type": [
            "Ransomware"
        ],
        "information": [
            ...
            "https://www.microsoft.com/security/blog/2022/05/09/ransomware-as-a-service-understandng-the-cybercrime-gig-economy-and-how-to-protect-yourself/",
        ...
        "uuid": "136ff666-8a9b-4a5c-8afb-ae0b77e171f1",
    ...
    "mitre": [
        {
            ...
            "procedure_code": "s0664",
            "procedure_type": "software",
            "procedure_link": "https://attack.mitre.org/software/S0664",
            "techniques": [
                {
                    "tactic_code": "ta0002",
                    ...
                    "procedure_description": "pandora has the ability to install itself as a windows service.[45]"
                },
                {
                    "tactic_code": "ta0003",
                    ...
                    "procedure_description": "pandora has the ability to gain system privileges through windows services.[86]"
                },
                {
                    "tactic_code": "ta0003",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0003",
                    ...
                    "procedure_description": "pandora can use dll side-loading to execute malicious payloads.[29]"
                },
                {
                    "tactic_code": "ta0003",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0003",
                ...
                },
                {
                    ...
                    "procedure_description": "pandora can use cve-2017-15303 to bypass windows driver signature enforcement (dse) protection and load its driver.[26]"
                },
                {
                    "tactic_code": "ta0004",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0004",
                ...
                },
                {
                    ...
                    "procedure_description": "pandora can start and inject code into a new svchost process.[43]"
                },
                {
                    "tactic_code": "ta0005",
                ...
                },
                {
                    ...
                    "procedure_description": "pandora can write an encrypted token to the registry to enable processing of remote commands.[111]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                    ...
                    "procedure_description": "pandora has the ability to compress stings with quicklz.[247]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                ...
                },
                {
                    ...
                    "procedure_description": "pandora can use cve-2017-15303 to disable windows driver signature enforcement (dse) protection and load its driver.[10]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                ...
                },
                {
                    ...
                    "procedure_description": "pandora can monitor processes on a compromised host.[192]"
                },
                {
                    "tactic_code": "ta0011",
                    ...
                    "procedure_description": "pandora can communicate over http.[242]"
                },
                {
                    "tactic_code": "ta0011",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0011",
                    ...
                    "procedure_description": "pandora has the ability to encrypt communications with d3des.[102]"
                },
                {
                    "tactic_code": "ta0011",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0011",
                    ...
                    "procedure_description": "pandora can load additional drivers and files onto a victim machine.[339]"
                },
                {
                    "tactic_code": "ta0011",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0011",
