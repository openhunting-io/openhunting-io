var threatdata = {
    ...
    "all_data": {
        ...
        "description": "(Bitdefender) The ccf32.exe binary is a command line tool used for data collection. Although this tool embeds more options the attackers could use, we have seen only one intensively used, the \u201c-PC\u201d option.",
        "category": "Malware",
        "type": [
            "Reconnaissance",
            "Info stealer"
        ...
        "uuid": "4b2a96fc-dc63-4de0-80d7-56bef2f6f014",
    ...
    "mitre": [
        {
            ...
            "procedure_code": "s1043",
            "procedure_type": "software",
            "procedure_link": "https://attack.mitre.org/software/S1043",
            "techniques": [
                {
                    "tactic_code": "ta0002",
                    ...
                    "procedure_description": "ccf32 has used cmd.exe for archiving data and deleting files.[65]"
                },
                {
                    "tactic_code": "ta0002",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0002",
                    ...
                    "procedure_description": "ccf32 can run on a daily basis using a scheduled task.[37]"
                },
                {
                    "tactic_code": "ta0003",
                ...
                },
                {
                    ...
                    "procedure_description": "ccf32 has created a hidden directory on targeted systems, naming it after the current local time (year, month, and day).[13]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                    ...
                    "procedure_description": "ccf32 can delete files and folders from compromised machines.[39]"
                },
                {
                    "tactic_code": "ta0007",
                    ...
                    "procedure_description": "ccf32 can parse collected files to identify specific file extensions.[70]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "ccf32 can determine the local time on targeted machines.[22]"
                },
                {
                    "tactic_code": "ta0009",
                    ...
                    "procedure_description": "ccf32 has used xcopy \\\\<target_host>\\c$\\users\\public\\path.7z c:\\users\\public\\bin\\<target_host>.7z /h /y to archive collected files.[17]"
                },
                {
                    "tactic_code": "ta0009",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0009",
                    ...
                    "procedure_description": "ccf32 can be used to automatically collect files from a compromised host.[7]"
                },
                {
                    "tactic_code": "ta0009",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0009",
                    ...
                    "procedure_description": "ccf32 can collect files from a compromised host.[37]"
                },
                {
                    "tactic_code": "ta0009",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0009",
                    ...
                    "procedure_description": "ccf32 can temporarily store files in a hidden directory on the local host.[21]"
                },
                {
                    "tactic_code": "ta0009",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0009",
                    ...
                    "procedure_description": "ccf32 has copied files to a remote machine infected with chinoxy or another backdoor.[3]"
                },
                {
                    "tactic_code": "ta0010",
                    ...
                    "procedure_description": "ccf32 can upload collected data and files to an ftp server.[11]"
                }
            ]
        }
    ],
