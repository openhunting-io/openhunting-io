var threatdata = {
    ...
    "all_data": {
        ...
        "uuid": "2fb2ec92-5ef7-44e5-b69c-3356ff2a328f",
    ...
    "mitre": [
        {
            ...
            "procedure_code": "s0456",
            "procedure_type": "software",
            "procedure_link": "https://attack.mitre.org/software/S0456",
            "techniques": [
                {
                    "tactic_code": "ta0002",
                    ...
                    "procedure_description": "aria-body has the ability to launch files using shellexecute.[20]"
                },
                {
                    "tactic_code": "ta0003",
                    ...
                    "procedure_description": "aria-body has established persistence via the startup folder or run registry key.[30]"
                },
                {
                    "tactic_code": "ta0004",
                    ...
                    "procedure_description": "aria-body has the ability to duplicate a token from ntprint.exe.[2]"
                },
                {
                    "tactic_code": "ta0004",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0004",
                    ...
                    "procedure_description": "aria-body has the ability to execute a process using runas.[2]"
                },
                {
                    "tactic_code": "ta0004",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0004",
                ...
                },
                {
                    ...
                    "procedure_description": "aria-body has the ability to inject itself into another process such as rundll32.exe and dllhost.exe.[5]"
                },
                {
                    "tactic_code": "ta0005",
                ...
                },
                {
                    ...
                    "procedure_description": "aria-body has the ability to decrypt the loader configuration and payload dll.[14]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                    ...
                    "procedure_description": "aria-body has the ability to delete files and directories on compromised hosts.[16]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                    ...
                    "procedure_description": "aria-body has used an encrypted configuration file for its loader.[38]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                ...
                },
                {
                    ...
                    "procedure_description": "aria-body has the ability to identify the titles of running windows on a compromised host.[3]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "aria-body has the ability to gather metadata from a file and to search for file and directory names.[20]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "aria-body has the ability to enumerate loaded modules for a process.[14]."
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "aria-body has the ability to identify the hostname, computer name, windows version, processor speed, machine guid, and disk information on a compromised host.[32]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "aria-body has the ability to identify the location, public ip address, and domain name on a compromised host.[21]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "aria-body has the ability to gather tcp and udp table status listings.[15]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "aria-body has the ability to identify the username on a compromised host.[18]"
                },
                {
                    "tactic_code": "ta0009",
                    ...
                    "procedure_description": "aria-body has used zip to compress data gathered on a compromised host.[6]"
                },
                {
                    "tactic_code": "ta0009",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0009",
                    ...
                    "procedure_description": "aria-body has the ability to collect data from usb devices.[4]"
                },
                {
                    "tactic_code": "ta0009",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0009",
                    ...
                    "procedure_description": "aria-body has the ability to capture screenshots on compromised hosts.[16]"
                },
                {
                    "tactic_code": "ta0011",
                    ...
                    "procedure_description": "aria-body has used http in c2 communications.[27]"
                },
                {
                    "tactic_code": "ta0011",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0011",
                    ...
                    "procedure_description": "aria-body has the ability to use a dga for c2 communications.[9]"
                },
                {
                    "tactic_code": "ta0011",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0011",
                    ...
                    "procedure_description": "aria-body has the ability to download additional payloads from c2.[38]"
                },
                {
                    "tactic_code": "ta0011",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0011",
                    ...
                    "procedure_description": "aria-body has used tcp in c2 communications.[6]"
                },
                {
                    "tactic_code": "ta0011",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0011",
