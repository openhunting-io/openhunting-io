var threatdata = {
    ...
    "articles": [
        {
            "data_url": "https://www.welivesecurity.com/2021/06/09/gelsemium-when-threat-actors-go-gardening/",
            "date": "2021-06-09",
        ...
        {
            "data_url": "https://www.venustech.com.cn/uploads/2018/08/231401512426.pdf",
            "date": "2018-08-15",
            "organization": "Beijing Venus Information Security Tech",
            "author": "VenusEye",
            "title": "APT organization Lemons Threat to Attack",
            "categories": [
                "Gelsemium"
            ]
        },
        {
            "data_url": "https://hitcon.org/2016/pacific/0composition/pdf/1202/1202%20R0%200930%20an%20intelligance-driven%20approach%20to%20cyber%20defense.pdf",
            "date": "2016",
            "organization": "Verint",
            "author": "Peikan Tsung",
            "title": "An Intelligence-Driven Approach to Cyber Defense",
            "categories": [
                "Gelsemium"
            ]
        },
        {
            "data_url": "https://public.gdatasoftware.com/Presse/Publikationen/Whitepaper/EN/GDATA_TooHash_CaseStudy_102014_EN_v1.pdf",
            "date": "2014-10-31",
            "organization": "G Data",
            "author": "G Data",
            "title": "OPERATION \u201cTOOHASH\u201d: HOW TARGETED ATTACKS WORK",
            "categories": [
                "Cohhoc",
                "Gelsemium"
            ]
    ...
    "mitre": [
        {
            "procedure_name": "gelsemium",
            "procedure_code": "s0666",
            "procedure_type": "software",
            "procedure_link": "https://attack.mitre.org/software/S0666",
            "techniques": [
                {
                    "tactic_code": "ta0002",
                    ...
                    "procedure_description": "gelsemium can use a batch script to delete itself.[138]"
                },
                {
                    "tactic_code": "ta0002",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0002",
                    ...
                    "procedure_description": "gelsemium can use the iarpuinstallerstringlauncher com interface are part of its uac bypass process.[8]"
                },
                {
                    "tactic_code": "ta0002",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0002",
                    ...
                    "procedure_description": "gelsemium has the ability to use various windows api functions to perform tasks.[53]"
                },
                {
                    "tactic_code": "ta0003",
                    ...
                    "procedure_description": "gelsemium can set persistence with a registry run key.[103]"
                },
                {
                    "tactic_code": "ta0003",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0003",
                    ...
                    "procedure_description": "gelsemium can drop itself in c:\\windows\\system32\\spool\\prtprocs\\x64\\winprint.dll to be loaded automatically by the spoolsv windows service.[4]"
                },
                {
                    "tactic_code": "ta0003",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0003",
                    ...
                    "procedure_description": "gelsemium can drop itself in c:\\windows\\system32\\spool\\prtprocs\\x64\\winprint.dll as an alternative print processor to be loaded automatically when the spoolsv windows service starts.[56]"
                },
                {
                    "tactic_code": "ta0004",
                    ...
                    "procedure_description": "gelsemium can bypass uac to elevate process privileges on a compromised host.[33]"
                },
                {
                    "tactic_code": "ta0004",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0004",
                    ...
                    "procedure_description": "gelsemium can use token manipulation to bypass uac on windows7 systems.[11]"
                },
                {
                    "tactic_code": "ta0004",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0004",
                ...
                },
                {
                    ...
                    "procedure_description": "gelsemium has the ability to inject dlls into specific processes.[32]"
                },
                {
                    "tactic_code": "ta0005",
                ...
                },
                {
                    ...
                    "procedure_description": "gelsemium can decompress and decrypt dlls and shellcode.[52]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                    ...
                    "procedure_description": "gelsemium can delete its dropper component from the targeted system.[83]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                    ...
                    "procedure_description": "gelsemium has the ability to perform timestomping of files on targeted systems.[27]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                    ...
                    "procedure_description": "gelsemium has used unverified signatures on malicious dlls.[4]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                    ...
                    "procedure_description": "gelsemium has named malicious binaries serv.exe, winprint.dll, and chrome_elf.dll and has set its persistence in the registry with the key value chrome update to appear legitimate.[63]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                    ...
                    "procedure_description": "gelsemium can modify the registry to store its components.[62]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                    ...
                    "procedure_description": "gelsemium has the ability to compress its components.[77]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                    ...
                    "procedure_description": "gelsemium can use junk code to hide functions and evade detection.[19]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                    ...
                    "procedure_description": "gelsemium can store its components in the registry.[10]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                ...
                },
                {
                    ...
                    "procedure_description": "gelsemium can use custom shellcode to map embedded dlls into memory.[13]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                    ...
                    "procedure_description": "gelsemium can use junk code to generate random activity to obscure malware behavior.[14]"
                },
                {
                    "tactic_code": "ta0007",
                    ...
                    "procedure_description": "gelsemium can retrieve data from specific windows directories, as well as open random files as part of virtualization/sandbox evasion.[135]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "gelsemium can enumerate running processes.[112]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "gelsemium can open random files and registry keys to obscure malware behavior from sandbox analysis.[45]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "gelsemium can check for the presence of specific security products.[47]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "gelsemium can determine the operating system and whether a targeted machine has a 32 or 64 bit architecture.[89]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "gelsemium has the ability to distinguish between a standard user and an administrator on a compromised host.[37]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                ...
                },
                {
                    ...
                    "procedure_description": "gelsemium can collect data from a compromised host.[43]"
                },
                {
                    "tactic_code": "ta0011",
                    ...
                    "procedure_description": "gelsemium can use http/s in c2 communications.[139]"
                },
                {
                    "tactic_code": "ta0011",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0011",
                    ...
                    "procedure_description": "gelsemium has the ability to use dns in communication with c2.[27]"
                },
                {
                    "tactic_code": "ta0011",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0011",
                    ...
                    "procedure_description": "gelsemium can use dynamic dns domain names in c2.[7]"
                },
                {
                    "tactic_code": "ta0011",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0011",
                    ...
                    "procedure_description": "gelsemium can use multiple domains and protocols in c2.[19]"
                },
                {
                    "tactic_code": "ta0011",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0011",
                    ...
                    "procedure_description": "gelsemium can download additional plug-ins to a compromised host.[112]"
                },
                {
                    "tactic_code": "ta0011",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0011",
                    ...
                    "procedure_description": "gelsemium has the ability to use tcp and udp in c2 communications.[27]"
                }
            ]
        }
    ]
