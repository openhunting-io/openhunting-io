var threatdata = {
    "name": "Karagany",
    "alias": "Karagany, Karagny, Trojan.Karagany, xFrost",
    "category": "Malware",
    ...
    "all_data": {
        ...
        "uuid": "433ea147-b7bc-458f-95ce-7dbc2d0d7747",
    ...
    "mitre": [
        {
            ...
            "procedure_code": "s0094",
            "procedure_type": "software",
            "procedure_link": "https://attack.mitre.org/software/S0094",
            "techniques": [
                {
                    "tactic_code": "ta0002",
                    ...
                    "procedure_description": "trojan.karagany can perform reconnaissance commands on a victim machine via a cmd.exe process.[335]"
                },
                {
                    "tactic_code": "ta0003",
                    ...
                    "procedure_description": "trojan.karagany can create a link to itself in the startup folder to automatically start itself upon system restart.[37][263]"
                },
                {
                    "tactic_code": "ta0004",
                ...
                },
                {
                    ...
                    "procedure_description": "trojan.karagany can inject a suspended thread of its own process into a new process and initiate via the resumethread api.[4]"
                },
                {
                    "tactic_code": "ta0005",
                    ...
                    "procedure_description": "trojan.karagany has used plugins with a self-delete capability.[242]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                    ...
                    "procedure_description": "trojan.karagany can base64 encode and aes-128-cbc encrypt data prior to transmission.[336]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                    ...
                    "procedure_description": "trojan.karagany samples sometimes use common binary packers such as upx and aspack on top of a custom delphi binary packer.[87][88]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                ...
                },
                {
                    ...
                    "procedure_description": "trojan.karagany can detect commonly used and generic virtualization platforms based primarily on drivers and file paths.[58]"
                },
                {
                    "tactic_code": "ta0006",
                    ...
                    "procedure_description": "trojan.karagany can steal data and credentials from browsers.[90]"
                },
                {
                    "tactic_code": "ta0006",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0006",
                    ...
                    "procedure_description": "trojan.karagany can capture keystrokes on a compromised host.[177]"
                },
                {
                    "tactic_code": "ta0006",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0006",
                    ...
                    "procedure_description": "trojan.karagany can dump passwords and save them into \\programdata\\mail\\mailag\\pwds.txt.[17]"
                },
                {
                    "tactic_code": "ta0007",
                    ...
                    "procedure_description": "trojan.karagany can monitor the titles of open windows to identify specific keywords.[32]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "trojan.karagany can enumerate files and directories on a compromised host.[305]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "trojan.karagany can use tasklist to collect a list of running tasks.[25][259]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "trojan.karagany can capture information regarding the victim's os, security, and hardware configuration.[375]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "trojan.karagany can gather information on the network configuration of a compromised host.[234]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "trojan.karagany can use netstat to collect a list of network connections.[88]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "trojan.karagany can gather information about the user on a compromised host.[190]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                ...
                },
                {
                    ...
                    "procedure_description": "trojan.karagany can create directories to store plugin output and stage data for exfiltration.[94][95]"
                },
                {
                    "tactic_code": "ta0009",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0009",
                ...
                },
                {
                    ...
                    "procedure_description": "trojan.karagany can take a desktop screenshot and save the file into \\programdata\\mail\\mailag\\shot.png.[169][170]"
                },
                {
                    "tactic_code": "ta0011",
                    ...
                    "procedure_description": "trojan.karagany can communicate with c2 via http post requests.[344]"
                },
                {
                    "tactic_code": "ta0011",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0011",
                    ...
                    "procedure_description": "trojan.karagany can secure c2 communications with ssl and tls.[60]"
                },
                {
                    "tactic_code": "ta0011",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0011",
