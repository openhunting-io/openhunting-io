    ...
    "mitre": [
        {
            ...
            "procedure_code": "s0657",
            "procedure_type": "software",
            "procedure_link": "https://attack.mitre.org/software/S0657",
            "techniques": [
                {
                    "tactic_code": "ta0005",
                    ...
                    "procedure_description": "bluelight can uninstall itself.[32]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                    ...
                    "procedure_description": "bluelight has a xor-encoded payload.[57]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                    ...
                    "procedure_description": "bluelight can check to see if the infected machine has vm tools running.[9]"
                },
                {
                    "tactic_code": "ta0006",
                    ...
                    "procedure_description": "bluelight can collect passwords stored in web browers, including internet explorer, edge, chrome, and naver whale.[16]"
                },
                {
                    "tactic_code": "ta0006",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0006",
                    ...
                    "procedure_description": "bluelight can harvest cookies from internet explorer, edge, chrome, and naver whale browsers.[6]"
                },
                {
                    "tactic_code": "ta0007",
                    ...
                    "procedure_description": "bluelight can enumerate files and collect associated metadata.[60]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "bluelight can collect process filenames and sid authority level.[39]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "bluelight can collect a list of anti-virus products installed on a machine.[12]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "bluelight has collected the computer name and os version from victim machines.[65]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "bluelight can collect ip information from the victim\u2019s machine.[40]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "bluelight can collect the username on a compromised host.[26]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "bluelight can collect the local time on a compromised host.[16]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                ...
                },
                {
                    ...
                    "procedure_description": "bluelight can zip files before exfiltration.[11]"
                },
                {
                    "tactic_code": "ta0009",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0009",
                    ...
                    "procedure_description": "bluelight has encoded data into a binary blob using xor.[4]"
                },
                {
                    "tactic_code": "ta0009",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0009",
                    ...
                    "procedure_description": "bluelight has captured a screenshot of the display every 30 seconds for the first 5 minutes after initiating a c2 loop, and then once every five minutes thereafter.[26]"
                },
                {
                    "tactic_code": "ta0011",
                    ...
                    "procedure_description": "bluelight can use http/s for c2 using the microsoft graph api.[44]"
                },
                {
                    "tactic_code": "ta0011",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0011",
                    ...
                    "procedure_description": "bluelight can download additional files onto the host.[29]"
                },
                {
                    "tactic_code": "ta0011",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0011",
                    ...
                    "procedure_description": "bluelight can use different cloud providers for its c2.[11]"
                },
                {
                    "tactic_code": "ta0010",
