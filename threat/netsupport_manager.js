var threatdata = {
    ...
    "all_data": {
        ...
        "names": [
            ...
            {
                "name": "NetSupportManager RAT"
            },
            {
                "name": "NetSupport"
            }
        ],
        "description": "(Palo Alto) This RAT is typically used for legitimate purposes allowing administrators remote access to client computers. However, malicious operators are installing the RAT to victim\u2019s systems allowing them to gain unauthorized access. The use of this NetSupport Manager RAT for unauthorized access has been observed in phishing campaigns since at least 2018.",
        "category": "Tools",
        "type": [
            "Backdoor"
        ],
        ...
        "uuid": "78c4aab3-63f3-4238-9ca9-5f9e07b2a871",
    ...
    "mitre": [
        {
            "procedure_name": "rtm",
            "procedure_code": "g0048",
            "procedure_type": "apt-group",
            "procedure_link": "https://attack.mitre.org/groups/G0048",
            "techniques": [
                {
                    "tactic_code": "ta0001",
                    ...
                    "procedure_description": "rtm has distributed its malware via the rig and sundown exploit kits, as well as online advertising network yandex.direct.[47][48]"
                },
                {
                    "tactic_code": "ta0001",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0001",
                    ...
                    "procedure_description": "rtm has been delivered via spearphishing attachments disguised as pdf documents.[198]"
                },
                {
                    "tactic_code": "ta0001",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0001",
                    ...
                    "technique_name": "phishing : spearphishing attachment",
                    "technique_description": "adversaries may send spearphishing emails with a malicious attachment in an attempt to gain access to victim systems. spearphishing attachment is a specific variant of spearphishing. spearphishing attachment is different from other forms of spearphishing in that it employs the use of malware attached to an email. all forms of spearphishing are electronically delivered social engineering targeted at a specific individual, company, or industry. in this scenario, adversaries attach a file to the spearphishing email and usually rely upon user execution to gain execution. spearphishing may also involve social engineering techniques, such as posing as a trusted source.",
                    "procedure_description": "rtm has used spearphishing attachments to distribute its malware.[199]"
                },
                {
                    "tactic_code": "ta0002",
                    ...
                    "procedure_description": "rtm uses the command line and rundll32.exe to execute.[291]"
                },
                {
                    "tactic_code": "ta0002",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0002",
                    ...
                    "procedure_description": "rtm can search for specific strings within browser tabs using a dynamic data exchange mechanism.[29]"
                },
                {
                    "tactic_code": "ta0002",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0002",
                    ...
                    "procedure_description": "rtm can use the findnexturlcacheentrya and findfirsturlcacheentrya functions to search for specific strings within browser history.[149]"
                },
                {
                    "tactic_code": "ta0002",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0002",
                    ...
                    "procedure_description": "rtm tries to add a scheduled task to establish persistence.[151][152]"
                },
                {
                    "tactic_code": "ta0002",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0002",
                    ...
                    "procedure_description": "rtm has relied on users opening malicious email attachments, decompressing the attached archive, and double-clicking the executable within.[206]"
                },
                {
                    "tactic_code": "ta0002",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0002",
                    ...
                    "technique_name": "user execution : malicious file",
                    "technique_description": "an adversary may rely upon a user opening a malicious file in order to gain execution. users may be subjected to social engineering to get them to open a file that will lead to code execution. this user action will typically be observed as follow-on behavior from spearphishing attachment. adversaries may use several types of files that require a user to execute them, including .doc, .pdf, .xls, .rtf, .scr, .exe, .lnk, .pif, and .cpl.",
                    "procedure_description": "rtm has attempted to lure victims into opening e-mail attachments to execute malicious code.[207]"
                },
                {
                    "tactic_code": "ta0003",
                    ...
                    "procedure_description": "rtm tries to add a registry run key under the name \"windows update\" to establish persistence.[228]"
                },
                {
                    "tactic_code": "ta0003",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0003",
                    ...
                    "technique_name": "boot or logon autostart execution : registry run keys / startup folder",
                    "technique_description": "adversaries may achieve persistence by adding a program to a startup folder or referencing it with a registry run key. adding an entry to the \"run keys\" in the registry or startup folder will cause the program referenced to be executed when a user logs in. these programs will be executed under the context of the user and will have the account's associated permissions level.",
                    "procedure_description": "rtm has used registry run keys to establish persistence for the rtm trojan and other tools, such as a modified version of teamviewer remote desktop software.[228][229]"
                },
                {
                    "tactic_code": "ta0003",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0003",
                    ...
                    "procedure_description": "rtm has used search order hijacking to force teamviewer to load a malicious dll.[34]"
                },
                {
                    "tactic_code": "ta0003",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0003",
                ...
                },
                {
                    ...
                    "procedure_description": "rtm can attempt to run the program as admin, then show a fake error message and a legitimate uac bypass prompt to the user in an attempt to socially engineer the user into escalating privileges.[54]"
                },
                {
                    "tactic_code": "ta0004",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0004",
                ...
                },
                {
                    ...
                    "procedure_description": "rtm can delete all files created during its execution.[205][206]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                    ...
                    "procedure_description": "rtm has the ability to remove registry entries that it created for persistence.[9]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                    ...
                    "procedure_description": "rtm has been delivered as archived windows executable files masquerading as pdf documents.[34]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                    ...
                    "procedure_description": "rtm has named the scheduled task it creates \"windows update\".[63]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                    ...
                    "procedure_description": "rtm can delete all registry entries created during its execution.[140]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                    ...
                    "procedure_description": "rtm strings, network data, configuration, and modules are encrypted with a modified rc4 algorithm. rtm has also been delivered to targets as various archive files including zip, 7-zip, and rar.[283][284]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                    ...
                    "procedure_description": "rtm samples have been signed with a code-signing certificates.[62]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                    ...
                    "procedure_description": "rtm can add a certificate to the windows store.[10][11]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                    ...
                    "procedure_description": "rtm runs its core dll file using rundll32.exe.[85][86]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                    ...
                    "procedure_description": "rtm can detect if it is running within a sandbox or other virtualized analysis environment.[20]"
                },
                {
                    "tactic_code": "ta0006",
                    ...
                    "procedure_description": "rtm can record keystrokes from both the keyboard and virtual keyboard.[160][161]"
                },
                {
                    "tactic_code": "ta0007",
                    ...
                    "procedure_description": "rtm can check for specific files and directories associated with virtualization and malware analysis.[267]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "rtm can obtain a list of smart card readers attached to the victim.[40][41]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "rtm can obtain information about process integrity levels.[222]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "rtm can scan victim drives to look for specific banking software on the machine to determine next actions.[26]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "rtm can obtain information about security software on the victim.[90]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "rtm can obtain the computer name, os version, and default language identifier.[322]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "rtm can obtain the victim username and permissions.[162]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "rtm can obtain the victim time zone.[61]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                ...
                },
                {
                    ...
                    "procedure_description": "rtm monitors browsing activity and automatically captures screenshots if a victim browses to a url matching one of a list of strings.[39][40]"
                },
                {
                    "tactic_code": "ta0009",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0009",
                    ...
                    "procedure_description": "rtm collects data from the clipboard.[41][42]"
                },
                {
                    "tactic_code": "ta0009",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0009",
                ...
                },
                {
                    ...
                    "procedure_description": "rtm can capture screenshots.[150][151]"
                },
                {
                    "tactic_code": "ta0011",
                    ...
                    "procedure_description": "rtm has initiated connections to external domains using https.[292]"
                },
                {
                    "tactic_code": "ta0011",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0011",
                    ...
                    "procedure_description": "rtm has resolved pony c2 server ip addresses by either converting bitcoin blockchain transaction data to specific octets, or accessing ip addresses directly within the namecoin blockchain.[13][14]"
                },
                {
                    "tactic_code": "ta0011",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0011",
                    ...
                    "procedure_description": "rtm encrypts c2 traffic with a custom rc4 variant.[117]"
                },
                {
                    "tactic_code": "ta0011",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0011",
                    ...
                    "procedure_description": "rtm can download additional files.[392][393]"
                },
                {
                    "tactic_code": "ta0011",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0011",
                    ...
                    "procedure_description": "rtm used port 44443 for its vnc module.[33]"
                },
                {
                    "tactic_code": "ta0011",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0011",
                    ...
                    "procedure_description": "rtm has the capability to download a vnc module from command and control (c2).[24]"
                },
                {
                    "tactic_code": "ta0011",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0011",
                    ...
                    "technique_name": "remote access software",
                    "technique_description": "an adversary may use legitimate desktop support and remote access software, such as team viewer, anydesk, go2assist, logmein, ammyyadmin, etc, to establish an interactive command and control channel to target systems within networks. these services are commonly used as legitimate technical support software, and may be allowed by application control within a target environment. remote access tools like vnc, ammyy, and teamviewer are used frequently when compared with other legitimate software commonly used by adversaries.",
                    "procedure_description": "rtm has used a modified version of teamviewer and remote utilities for remote access.[25]"
                },
                {
                    "tactic_code": "ta0011",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0011",
                    ...
                    "procedure_description": "rtm has used an rss feed on livejournal to update a list of encrypted c2 server names. rtm has also hidden pony c2 server ip addresses within transactions on the bitcoin and namecoin blockchain.[18][19][20]"
                },
                {
                    "tactic_code": "ta0011",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0011",
