var threatdata = {
    ...
    "alias": "Cobra Carbon System, Carbon, Pfinet",
    "category": "Malware",
    ...
    "all_data": {
        ...
        "uuid": "79fe32be-7715-4434-9d17-ae2e0af84425",
    ...
    "mitre": [
        {
            ...
            "procedure_code": "s0335",
            "procedure_type": "software",
            "procedure_link": "https://attack.mitre.org/software/S0335",
            "techniques": [
                {
                    "tactic_code": "ta0002",
                    ...
                    "procedure_description": "carbon creates several tasks for later execution to continue persistence on the victim\u2019s machine.[36]"
                },
                {
                    "tactic_code": "ta0003",
                    ...
                    "procedure_description": "carbon establishes persistence by creating a service and naming it based off the operating system version running on the current machine.[31]"
                },
                {
                    "tactic_code": "ta0003",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0003",
                ...
                },
                {
                    ...
                    "procedure_description": "carbon has a command to inject code into a process.[12]"
                },
                {
                    "tactic_code": "ta0004",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0004",
                ...
                },
                {
                    ...
                    "procedure_description": "carbon decrypts task and configuration files for execution.[46][47]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                    ...
                    "procedure_description": "carbon encrypts configuration files and tasks for the malware to complete using cast-128 algorithm.[71][72]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                ...
                },
                {
                    ...
                    "procedure_description": "carbon uses the net group command.[3]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "carbon can list the processes on the victim\u2019s machine.[53]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "carbon enumerates values in the registry.[20]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "carbon uses the net view command.[24]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "carbon can collect the ip address of the victims and other computers on the network using the commands: ipconfig -all nbtstat -n, and nbtstat -s.[48][49]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "carbon uses the netstat -r and netstat -an commands.[20]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "carbon uses the command net time \\127.0.0.1 to get information the system\u2019s time.[21]"
                },
                {
                    "tactic_code": "ta0009",
                    ...
                    "procedure_description": "carbon creates a base directory that contains the files and folders that are collected.[19]"
                },
                {
                    "tactic_code": "ta0011",
                    ...
                    "procedure_description": "carbon can use http in c2 communications.[56]"
                },
                {
                    "tactic_code": "ta0011",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0011",
                    ...
                    "procedure_description": "carbon has used rsa encryption for c2 communications.[7]"
                },
                {
                    "tactic_code": "ta0011",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0011",
                    ...
                    "procedure_description": "carbon uses tcp and udp for c2.[15]"
                },
                {
                    "tactic_code": "ta0011",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0011",
                    ...
                    "procedure_description": "carbon can use pastebin to receive c2 commands.[8]"
                },
                {
                    "tactic_code": "ta0010",
