var threatdata = {
    ...
    "all_data": {
        ...
        "uuid": "d28da07e-739e-4928-86d4-6fc6f2bc77e2",
    ...
    "mitre": [
        {
            ...
            "procedure_code": "s0681",
            "procedure_type": "software",
            "procedure_link": "https://attack.mitre.org/software/S0681",
            "techniques": [
                {
                    "tactic_code": "ta0002",
                    ...
                    "procedure_description": "lizar has used powershell scripts.[138]"
                },
                {
                    "tactic_code": "ta0002",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0002",
                    ...
                    "procedure_description": "lizar has a command to open the command-line on the infected system.[194][195]"
                },
                {
                    "tactic_code": "ta0002",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0002",
                    ...
                    "procedure_description": "lizar has used various windows api functions on a victim's machine.[111]"
                },
                {
                    "tactic_code": "ta0004",
                    ...
                    "procedure_description": "lizar can migrate the loader into another process.[36]"
                },
                {
                    "tactic_code": "ta0004",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0004",
                    ...
                    "procedure_description": "lizar has used the powerkatz plugin that can be loaded into the address space of a powershell process through reflective dll loading.[42]"
                },
                {
                    "tactic_code": "ta0004",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0004",
                    ...
                    "procedure_description": "lizar can execute pe files in the address space of the specified process.[6]"
                },
                {
                    "tactic_code": "ta0005",
                    ...
                    "procedure_description": "lizar can decrypt its configuration data.[135]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                ...
                },
                {
                    ...
                    "procedure_description": "lizar has a module to collect usernames and passwords stored in browsers.[46]"
                },
                {
                    "tactic_code": "ta0006",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0006",
                    ...
                    "procedure_description": "lizar has a plugin that can retrieve credentials from internet explorer and microsoft edge using vaultcmd.exe and another that can collect rdp access credentials using the credenumeratew function.[9]"
                },
                {
                    "tactic_code": "ta0006",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0006",
                    ...
                    "procedure_description": "lizar can run mimikatz to harvest credentials.[49][50]"
                },
                {
                    "tactic_code": "ta0007",
                    ...
                    "procedure_description": "lizar can collect email accounts from microsoft outlook and mozilla thunderbird.[10]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "lizar can retrieve browser history and database files.[11][12]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "lizar has a plugin designed to obtain a list of processes.[158][159]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "lizar can search for processes associated with an anti-virus product from list.[57]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "lizar can collect the computer name from the machine,.[209]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "lizar can retrieve network information from a compromised host.[130]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "lizar has a plugin to retrieve information about all active network sessions on the infected server.[46]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "lizar can collect the username from the system.[102]"
                },
                {
                    "tactic_code": "ta0009",
                    ...
                    "procedure_description": "lizar has encrypted data before sending it to the server.[34]"
                },
                {
                    "tactic_code": "ta0009",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0009",
                    ...
                    "procedure_description": "lizar can take jpeg screenshots of an infected system.[91][92]"
                },
                {
                    "tactic_code": "ta0011",
                    ...
                    "procedure_description": "lizar can support encrypted communications between the client and server.[6][7]"
                },
                {
                    "tactic_code": "ta0011",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0011",
                    ...
                    "procedure_description": "lizar can download additional plugins, files, and tools.[265]"
                }
            ]
        }
    ],
