var threatdata = {
    ...
    "all_data": {
        ...
        "uuid": "b38c64f4-8c44-4c8a-b4c4-8fdd33cba785",
    ...
    "mitre": [
        {
            ...
            "procedure_code": "s0247",
            "procedure_type": "software",
            "procedure_link": "https://attack.mitre.org/software/S0247",
            "techniques": [
                {
                    "tactic_code": "ta0002",
                    ...
                    "procedure_description": "navrat leverages cmd.exe to perform discovery techniques.[232] navrat loads malicious shellcode and executes it in memory.[232]"
                },
                {
                    "tactic_code": "ta0003",
                    ...
                    "procedure_description": "navrat creates a registry key to ensure a file gets executed upon reboot in order to establish persistence.[177]"
                },
                {
                    "tactic_code": "ta0004",
                ...
                },
                {
                    ...
                    "procedure_description": "navrat copies itself into a running internet explorer process to evade detection.[39]"
                },
                {
                    "tactic_code": "ta0005",
                ...
                },
                {
                    ...
                    "procedure_description": "navrat logs the keystrokes on the targeted system.[120]"
                },
                {
                    "tactic_code": "ta0007",
                    ...
                    "procedure_description": "navrat uses tasklist /v to check running processes.[179]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "navrat uses systeminfo on a victim\u2019s machine.[247]"
                },
                {
                    "tactic_code": "ta0009",
                    ...
                    "procedure_description": "navrat writes multiple outputs to a tmp file using the >> method.[66]"
                },
                {
                    "tactic_code": "ta0009",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0009",
                ...
                },
                {
                    ...
                    "procedure_description": "navrat uses the email platform, naver, for c2 communications, leveraging smtp.[16]"
                },
                {
                    "tactic_code": "ta0011",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0011",
                    ...
                    "procedure_description": "navrat can download files remotely.[311]"
                }
            ]
        },
        {
