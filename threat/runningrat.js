    ...
    "mitre": [
        {
            ...
            "procedure_code": "s0253",
            "procedure_type": "software",
            "procedure_link": "https://attack.mitre.org/software/S0253",
            "techniques": [
                {
                    "tactic_code": "ta0002",
                    ...
                    "procedure_description": "runningrat uses a batch file to kill a security program task and then attempts to remove itself.[139]"
                },
                {
                    "tactic_code": "ta0003",
                    ...
                    "procedure_description": "runningrat adds itself to the registry key software\\microsoft\\windows\\currentversion\\run to establish persistence upon reboot.[106]"
                },
                {
                    "tactic_code": "ta0004",
                ...
                },
                {
                    ...
                    "procedure_description": "runningrat kills antimalware running process.[16]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                    ...
                    "procedure_description": "runningrat contains code to clear event logs.[29]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                    ...
                    "procedure_description": "runningrat contains code to delete files from the victim\u2019s machine.[86]"
                },
                {
                    "tactic_code": "ta0006",
                    ...
                    "procedure_description": "runningrat captures keystrokes and sends them back to the c2 server.[162]"
                },
                {
                    "tactic_code": "ta0007",
                    ...
                    "procedure_description": "runningrat gathers the os version, logical drives information, processor information, and volume information.[68]"
                },
                {
                    "tactic_code": "ta0009",
                    ...
                    "procedure_description": "runningrat contains code to compress files.[25]"
                },
                {
                    "tactic_code": "ta0009",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0009",
                    ...
                    "procedure_description": "runningrat contains code to open and copy data from the clipboard.[43]"
                },
                {
                    "tactic_code": "ta0009",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0009",
