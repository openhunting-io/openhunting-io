var threatdata = {
    ...
    "all_data": {
        ...
        "uuid": "fca0a40a-ae80-4525-82ad-ca1cf627344a",
    ...
    "mitre": [
        {
            ...
            "procedure_code": "s0348",
            "procedure_type": "software",
            "procedure_link": "https://attack.mitre.org/software/S0348",
            "techniques": [
                {
                    "tactic_code": "ta0002",
                    ...
                    "procedure_description": "cardinal rat can execute commands.[62]"
                },
                {
                    "tactic_code": "ta0002",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0002",
                    ...
                    "procedure_description": "cardinal rat lures victims into executing malicious macros embedded within microsoft excel documents.[56]"
                },
                {
                    "tactic_code": "ta0003",
                    ...
                    "procedure_description": "cardinal rat establishes persistence by setting the  hkcu\\software\\microsoft\\windows nt\\currentversion\\windows\\load registry key to point to its executable.[54]"
                },
                {
                    "tactic_code": "ta0004",
                ...
                },
                {
                    ...
                    "procedure_description": "cardinal rat injects into a newly spawned process created from a native windows executable.[12]"
                },
                {
                    "tactic_code": "ta0005",
                    ...
                    "procedure_description": "cardinal rat decodes many of its artifacts and is decrypted (aes-128) after being downloaded.[48]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                    ...
                    "procedure_description": "cardinal rat can uninstall itself, including deleting its executable.[37]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                    ...
                    "procedure_description": "cardinal rat sets hkcu\\software\\microsoft\\windows nt\\currentversion\\windows\\load to point to its executable.[30]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                    ...
                    "procedure_description": "cardinal rat encodes many of its artifacts and is encrypted (aes-128) when downloaded.[73]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                    ...
                    "procedure_description": "cardinal rat and its watchdog component are compiled and executed after being delivered to victims as embedded, uncompiled source code.[3]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                ...
                },
                {
                    ...
                    "procedure_description": "cardinal rat can log keystrokes.[35]"
                },
                {
                    "tactic_code": "ta0007",
                    ...
                    "procedure_description": "cardinal rat checks its current working directory upon execution and also contains watchdog functionality that ensures its executable is located in the correct path (else it will rewrite the payload).[68]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "cardinal rat contains watchdog functionality that ensures its process is always running, else spawns a new instance.[54]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "cardinal rat contains watchdog functionality that periodically ensures hkcu\\software\\microsoft\\windows nt\\currentversion\\windows\\load is set to point to its executable.[21]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "cardinal rat can collect the hostname, microsoft windows version, and processor architecture from a victim machine.[80]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "cardinal rat can collect the username from a victim machine.[33]"
                },
                {
                    "tactic_code": "ta0009",
                    ...
                    "procedure_description": "cardinal rat applies compression to c2 traffic using the zlib library.[6]"
                },
                {
                    "tactic_code": "ta0009",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0009",
                ...
                },
                {
                    ...
                    "procedure_description": "cardinal rat can capture screenshots.[34]"
                },
                {
                    "tactic_code": "ta0011",
                    ...
                    "procedure_description": "cardinal rat is downloaded using http over port 443.[57]"
                },
                {
                    "tactic_code": "ta0011",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0011",
                    ...
                    "procedure_description": "cardinal rat uses a secret key with a series of xor and addition operations to encrypt c2 traffic.[25]"
                },
                {
                    "tactic_code": "ta0011",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0011",
                    ...
                    "procedure_description": "cardinal rat can communicate over multiple c2 host and port combinations.[9]"
                },
                {
                    "tactic_code": "ta0011",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0011",
                    ...
                    "procedure_description": "cardinal rat can download and execute additional payloads.[95]"
                },
                {
                    "tactic_code": "ta0011",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0011",
                    ...
                    "procedure_description": "cardinal rat can act as a reverse proxy.[9]"
                }
            ]
        },
        {
