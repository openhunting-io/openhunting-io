var threatdata = {
    ...
    "all_data": {
        ...
        "alienvault-otx": [
            "https://otx.alienvault.com/browse/pulses?q=tag:RevengeRAT"
        ],
        "uuid": "11f55202-a2da-4146-b5e3-863e3f7cca8e",
    ...
    "mitre": [
        {
            ...
            "procedure_code": "s0379",
            "procedure_type": "software",
            "procedure_link": "https://attack.mitre.org/software/S0379",
            "techniques": [
                {
                    "tactic_code": "ta0002",
                    ...
                    "procedure_description": "revenge rat uses the powershell command reflection.assembly to load itself into memory to aid in execution.[198]"
                },
                {
                    "tactic_code": "ta0002",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0002",
                    ...
                    "procedure_description": "revenge rat uses cmd.exe to execute commands and run scripts on the victim's machine.[281]"
                },
                {
                    "tactic_code": "ta0002",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0002",
                    ...
                    "procedure_description": "revenge rat schedules tasks to run malicious scripts at different intervals.[150]"
                },
                {
                    "tactic_code": "ta0003",
                    ...
                    "procedure_description": "revenge rat creates a registry key at hkcu\\software\\microsoft\\windows nt\\currentversion\\winlogon\\shell to survive a system reboot.[223]"
                },
                {
                    "tactic_code": "ta0003",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0003",
                ...
                },
                {
                    ...
                    "procedure_description": "revenge rat uses the forfiles utility to execute commands on the system.[4]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                    ...
                    "procedure_description": "revenge rat uses mshta.exe to run malicious scripts on the system.[30]"
                },
                {
                    "tactic_code": "ta0006",
                    ...
                    "procedure_description": "revenge rat has a plugin for keylogging.[155][156]"
                },
                {
                    "tactic_code": "ta0006",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0006",
                    ...
                    "procedure_description": "revenge rat has a plugin for credential harvesting.[13]"
                },
                {
                    "tactic_code": "ta0007",
                    ...
                    "procedure_description": "revenge rat collects the cpu information, os information, and system language.[302]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "revenge rat collects the ip address and mac address from the system.[197]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "revenge rat gathers the username from the system.[157]"
                },
                {
                    "tactic_code": "ta0008",
                    ...
                    "procedure_description": "revenge rat has a plugin to perform rdp access.[48]"
                },
                {
                    "tactic_code": "ta0009",
                    ...
                    "procedure_description": "revenge rat has a plugin for microphone interception.[33][34]"
                },
                {
                    "tactic_code": "ta0009",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0009",
                ...
                },
                {
                    ...
                    "procedure_description": "revenge rat has a plugin for screen capture.[142]"
                },
                {
                    "tactic_code": "ta0009",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0009",
                    ...
                    "procedure_description": "revenge rat has the ability to access the webcam.[39][40]"
                },
                {
                    "tactic_code": "ta0011",
                    ...
                    "procedure_description": "revenge rat uses base64 to encode information sent to the c2 server.[77]"
                },
                {
                    "tactic_code": "ta0011",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0011",
                    ...
                    "procedure_description": "revenge rat has the ability to upload and download files.[381]"
                },
                {
                    "tactic_code": "ta0011",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0011",
                    ...
                    "procedure_description": "revenge rat used blogpost.com as its primary command and control server during a campaign.[40]"
                }
            ]
        },
        {
