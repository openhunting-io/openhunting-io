var threatdata = {
    ...
    "all_data": {
        ...
        "uuid": "1be50485-7c9f-45dc-96b5-1cd8d2977a0e",
    ...
    "mitre": [
        {
            "procedure_name": "zebrocy",
            "procedure_code": "s0251",
            "procedure_type": "software",
            "procedure_link": "https://attack.mitre.org/software/S0251",
            "techniques": [
                {
                    "tactic_code": "ta0002",
                    ...
                    "procedure_description": "zebrocy uses cmd.exe to execute commands on the system.[355][356]"
                },
                {
                    "tactic_code": "ta0002",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0002",
                    ...
                    "procedure_description": "zebrocy has a command to create a scheduled task for persistence.[183]"
                },
                {
                    "tactic_code": "ta0002",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0002",
                    ...
                    "procedure_description": "one variant of zebrocy uses wmi queries to gather information.[137]"
                },
                {
                    "tactic_code": "ta0003",
                    ...
                    "procedure_description": "zebrocy creates an entry in a registry run key for the malware to execute on startup.[281][282][283]"
                },
                {
                    "tactic_code": "ta0003",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0003",
                    ...
                    "procedure_description": "zebrocy performs persistence with a logon script via adding to the registry key hkcu\\environment\\userinitmprlogonscript.[9]"
                },
                {
                    "tactic_code": "ta0003",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0003",
                ...
                },
                {
                    ...
                    "procedure_description": "zebrocy decodes its secondary payload and writes it to the victim\u2019s machine. zebrocy also uses aes and xor to decrypt strings and payloads.[263][264]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                    ...
                    "procedure_description": "zebrocy has a command to delete files and directories.[258][259][260]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                    ...
                    "procedure_description": "zebrocy's delphi variant was packed with upx.[93][94]"
                },
                {
                    "tactic_code": "ta0006",
                    ...
                    "procedure_description": "zebrocy has the capability to upload dumper tools that extract credentials from web browsers and store them in database files.[96]"
                },
                {
                    "tactic_code": "ta0006",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0006",
                    ...
                    "procedure_description": "zebrocy installs an application-defined windows hook to get notified when a network drive has been attached, so it can then use the hook to call its recordtofile file stealing method.[15]"
                },
                {
                    "tactic_code": "ta0007",
                    ...
                    "procedure_description": "zebrocy searches for files that are 60mb and less and contain the following extensions: .doc, .docx, .xls, .xlsx, .ppt, .pptx, .exe, .zip, and .rar. zebrocy also runs the echo %appdata% command to list the contents of the directory.[334][335][336] zebrocy can obtain the current execution path as well as perform drive enumeration.[337][338]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "zebrocy identifies network drives when they are added to victim systems.[62]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "zebrocy enumerates information about connected storage devices.[52]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "zebrocy uses the tasklist and wmic process get capture, executablepath commands to gather the processes running on the system.[49][278][50][279][280]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "zebrocy executes the reg query command to obtain information in the registry.[105]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "zebrocy collects the os version, computer name and serial number for the storage volume c:. zebrocy also runs the systeminfo command to gather system information. [404][77][405][78][406][407][408]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "zebrocy runs the ipconfig /all command.[254]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "zebrocy uses netstat -aon to gather network connection information.[94]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "zebrocy gets the username from the system.[205][206]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "zebrocy gathers the current time zone and date information from the system.[82][83]"
                },
                {
                    "tactic_code": "ta0009",
                    ...
                    "procedure_description": "zebrocy  has used a method similar to rc4 as well as aes for encryption and hexadecimal for encoding data before exfiltration. [52][53][54]"
                },
                {
                    "tactic_code": "ta0009",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0009",
                    ...
                    "procedure_description": "zebrocy scans the system and automatically collects files with the following extensions: .doc, .docx, ,.xls, .xlsx, .pdf, .pptx, .rar, .zip, .jpg, .jpeg, .bmp, .tiff, .kum, .tlg, .sbx, .cr, .hse, .hsf, and .lhz.[52][53]"
                },
                {
                    "tactic_code": "ta0009",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0009",
                    ...
                    "procedure_description": "zebrocy stores all collected information in a single file before exfiltration.[99]"
                },
                {
                    "tactic_code": "ta0009",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0009",
                ...
                },
                {
                    ...
                    "procedure_description": "a variant of zebrocy captures screenshots of the victim\u2019s machine in jpeg and bmp format.[31][181][182][183][184][185]"
                },
                {
                    "tactic_code": "ta0011",
                    ...
                    "procedure_description": "zebrocy uses http for c2.[376][377][378][379][380][381]"
                },
                {
                    "tactic_code": "ta0011",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0011",
                    ...
                    "procedure_description": "zebrocy uses smtp and pop3 for c2.[24][9][25][26][27][28]"
                },
                {
                    "tactic_code": "ta0011",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0011",
                    ...
                    "procedure_description": "zebrocy has used url/percent encoding on data exfiltrated via http post requests.[97]"
                },
                {
                    "tactic_code": "ta0011",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0011",
                    ...
                    "procedure_description": "zebrocy uses ssl and aes ecb for encrypting c2 communications.[72][73][74]"
                },
                {
                    "tactic_code": "ta0011",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0011",
                    ...
                    "procedure_description": "zebrocy obtains additional code to execute on the victim's machine, including the downloading of a secondary payload.[487][92][488][17]"
                },
                {
                    "tactic_code": "ta0010",
                    ...
                    "procedure_description": "zebrocy has exfiltrated data to the designated c2 server using http post requests.[147][148]"
                }
            ]
        }
    ],
    ...
    "articles": [
        ...
        {
            "data_url": "https://cocomelonc.github.io/persistence/2022/12/09/malware-pers-20.html",
            "date": "2022-12-09",
        ...
        {
            "data_url": "https://brandefense.io/zebrocy-malware-technical-analysis-report/",
            "date": "2022-04-10",
        ...
        {
            "data_url": "https://www.intezer.com/blog/research/russian-apt-uses-covid-19-lures-to-deliver-zebrocy/",
            "date": "2020-12-09",
            "organization": "Intezer",
        ...
        {
            "data_url": "https://us-cert.cisa.gov/ncas/analysis-reports/ar20-303b",
            "date": "2020-10-29",
        ...
        {
            "data_url": "https://mp.weixin.qq.com/s/6R7bFs9lH1I3BNdkatCC9g",
            "date": "2020-10-23",
            "organization": "360",
        ...
        {
            "data_url": "https://www.bleepingcomputer.com/news/security/russian-hackers-use-fake-nato-training-docs-to-breach-govt-networks/",
            "date": "2020-09-22",
        ...
        {
            "data_url": "https://quointelligence.eu/2020/09/apt28-zebrocy-malware-campaign-nato-theme/",
            "date": "2020-09-22",
        ...
        {
            "data_url": "https://mp.weixin.qq.com/s/pE_6VRDk-2aTI996sff0og",
            "date": "2020-07-01",
            "organization": "360",
            "author": "360 Threat Intelligence Center",
            "title": "\u6e38\u8d70\u5728\u4e1c\u6b27\u548c\u4e2d\u4e9a\u7684\u5947\u5e7b\u718a",
        ...
        {
            "data_url": "https://meltx0r.github.io/tech/2019/10/24/apt28.html",
            "date": "2019-10-24",
        ...
        {
            "data_url": "https://www.welivesecurity.com/2019/09/24/no-summer-vacations-zebrocy/",
            "date": "2019-09-24",
        ...
        {
            "data_url": "https://securelist.com/zebrocys-multilanguage-malware-salad/90680/",
            "date": "2019-06-03",
            "organization": "Kaspersky Labs",
            "author": "GReAT",
        ...
        {
            "data_url": "https://www.welivesecurity.com/2019/05/22/journey-zebrocy-land/",
            "date": "2019-05-22",
            "organization": "ESET Research",
            "author": "ESET Research",
        ...
        {
            "data_url": "https://research.checkpoint.com/malware-against-the-c-monoculture/",
            "date": "2019-05-20",
        ...
        {
            "data_url": "https://securelist.com/a-zebrocy-go-downloader/89419/",
            "date": "2019-01-11",
            "organization": "Kaspersky Labs",
            "author": "GReAT",
        ...
        {
            "data_url": "https://www.vkremez.com/2018/12/lets-learn-dissecting-apt28sofacy.html",
            "date": "2018-12-21",
            "organization": "",
        ...
        {
            "data_url": "https://unit42.paloaltonetworks.com/sofacy-creates-new-go-variant-of-zebrocy-tool/",
            "date": "2018-12-18",
        ...
        {
            "data_url": "https://www.vkremez.com/2018/12/lets-learn-reviewing-sofacys-zebrocy-c.html",
            "date": "2018-12-10",
        ...
        {
            "data_url": "https://www.accenture.com/us-en/blogs/blogs-snakemackerel-delivers-zekapab-malware",
            "date": "2018-11-29",
        ...
        {
            "data_url": "https://www.welivesecurity.com/2018/11/20/sednit-whats-going-zebrocy/",
            "date": "2018-11-20",
            "organization": "ESET Research",
            "author": "ESET Research",
        ...
        {
            "data_url": "https://www.welivesecurity.com/2018/04/24/sednit-update-analysis-zebrocy/",
            "date": "2018-04-24",
            "organization": "ESET Research",
            "author": "ESET Research",
