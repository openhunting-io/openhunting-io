var threatdata = {
    "name": "Promethium, StrongPity",
    "alias": "Promethium, StrongPity, APT-C-41",
    "category": "APT",
    "type": "-",
    "modified": "2023-02-15",
    "all_data": {
        "actor": "Promethium, StrongPity",
        "names": [
            {
                "name": "Promethium",
    ...
    "file_name": "promethium_strongpity",
    "analysis": null,
    "articles": [
        {
    ...
    "mitre": [
        {
            "procedure_name": "promethium",
            "procedure_code": "g0056",
            "procedure_type": "apt-group",
            "procedure_link": "https://attack.mitre.org/groups/G0056",
            "techniques": [
                {
                    "tactic_code": "ta0042",
                    ...
                    "procedure_description": "promethium has created self-signed certificates to sign malicious installers.[4]"
                },
                {
                    "tactic_code": "ta0042",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0042",
                    ...
                    "tactic_alias": "resource_development",
                    "tactic_description": "The adversary is trying to establish resources they can use to support operations.",
                    "technique_code": "t1587.003",
                    "technique_link": "https://attack.mitre.org/techniques/T1587/003",
                    ...
                    "procedure_description": "promethium has created self-signed digital certificates for use in https c2 traffic.[4]"
                },
                {
                    "tactic_code": "ta0001",
                    ...
                    "procedure_description": "promethium has used watering hole attacks to deliver malicious versions of legitimate installers.[42]"
                },
                {
                    "tactic_code": "ta0001",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0001",
                    ...
                    "procedure_description": "promethium has created admin accounts on a compromised host.[11]"
                },
                {
                    "tactic_code": "ta0002",
                    ...
                    "procedure_description": "promethium has attempted to get users to execute compromised installation files for legitimate software including compression applications, security software, browsers, file recovery applications, and other tools and utilities.[188][189]"
                },
                {
                    "tactic_code": "ta0003",
                    ...
                    "procedure_description": "promethium has used registry run keys to establish persistence.[205]"
                },
                {
                    "tactic_code": "ta0003",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0003",
                    ...
                    "procedure_description": "promethium has created new services and modified existing services for persistence.[97]"
                },
                {
                    "tactic_code": "ta0003",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0003",
                    ...
                    "tactic_alias": "persistence",
                    "tactic_description": "The adversary is trying to maintain their foothold.",
                    "technique_code": "t1205.001",
                    "technique_link": "https://attack.mitre.org/techniques/T1205/001",
                    "technique_name": "traffic signaling : port knocking",
                    "technique_description": "adversaries may use port knocking to hide open ports used for persistence or command and control. to enable a port, an adversary sends a series of attempted connections to a predefined sequence of closed ports. after the sequence is completed, opening a port is often accomplished by the host based firewall, but could also be implemented by custom software.",
                    "procedure_description": "promethium has used a script that configures the knockd service and firewall to only accept c2 connections from systems that use a specified sequence of knock ports.[4]"
                },
                {
                    "tactic_code": "ta0003",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0003",
                ...
                },
                {
                    ...
                    "procedure_description": "promethium has named services to appear legitimate.[57][58]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                    ...
                    "procedure_description": "promethium has disguised malicious installer files by bundling them with legitimate software installers.[127][128]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                    ...
                    "procedure_description": "promethium has signed code with self-signed certificates.[58]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
        ...
        },
        {
            ...
            "procedure_code": "s0491",
            "procedure_type": "software",
            "procedure_link": "https://attack.mitre.org/software/S0491",
            "techniques": [
                {
                    "tactic_code": "ta0002",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0002",
                    ...
                    "procedure_description": "strongpity can use powershell to add files to the windows defender exclusions list.[219]"
                },
                {
                    "tactic_code": "ta0002",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0002",
                    ...
                    "procedure_description": "strongpity can install a service to execute itself as a service.[57][58]"
                },
                {
                    "tactic_code": "ta0002",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0002",
                    ...
                    "technique_name": "user execution : malicious file",
                    "technique_description": "an adversary may rely upon a user opening a malicious file in order to gain execution. users may be subjected to social engineering to get them to open a file that will lead to code execution. this user action will typically be observed as follow-on behavior from spearphishing attachment. adversaries may use several types of files that require a user to execute them, including .doc, .pdf, .xls, .rtf, .scr, .exe, .lnk, .pif, and .cpl.",
                    "procedure_description": "strongpity has been executed via compromised installation files for legitimate software including compression applications, security software, browsers, file recovery applications, and other tools and utilities.[188][189]"
                },
                {
                    "tactic_code": "ta0003",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0003",
                    ...
                    "technique_name": "boot or logon autostart execution : registry run keys / startup folder",
                    "technique_description": "adversaries may achieve persistence by adding a program to a startup folder or referencing it with a registry run key. adding an entry to the \"run keys\" in the registry or startup folder will cause the program referenced to be executed when a user logs in. these programs will be executed under the context of the user and will have the account's associated permissions level.",
                    "procedure_description": "strongpity can use the hkcu\\software\\microsoft\\windows\\currentversion\\run registry key for persistence.[205]"
                },
                {
                    "tactic_code": "ta0003",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0003",
                    ...
                    "technique_name": "create or modify system process : windows service",
                    "technique_description": "adversaries may create or modify windows services to repeatedly execute malicious payloads as part of persistence. when windows boots up, it starts programs or applications called services that perform background system functions. windows service configuration information, including the file path to the service's executable or recovery programs/commands, is stored in the windows registry.",
                    "procedure_description": "strongpity has created new services and modified existing services for persistence.[115]"
                },
                {
                    "tactic_code": "ta0004",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0004",
                ...
                },
                {
                    ...
                    "procedure_description": "strongpity has the ability to hide the console window for its document search module from the user.[37]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                    ...
                    "procedure_description": "strongpity can add directories used by the malware to the windows defender exclusions list to prevent detection.[83]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                    ...
                    "procedure_description": "strongpity can delete previously exfiltrated files from the compromised host.[227][228]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                    ...
                    "technique_name": "masquerading : masquerade task or service",
                    "technique_description": "adversaries may attempt to manipulate the name of a task or service to make it appear legitimate or benign. tasks/services executed by the task scheduler or systemd will typically be given a name and/or description. windows services will have a service name as well as a display name. many benign tasks and services exist that have commonly associated names. adversaries may give tasks or services names that are similar or identical to those of legitimate ones.",
                    "procedure_description": "strongpity has named services to appear legitimate.[57][58]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                    ...
                    "technique_name": "masquerading : match legitimate name or location",
                    "technique_description": "adversaries may match or approximate the name or location of legitimate files or resources when naming/placing them. this is done for the sake of evading defenses and observation. this may be done by placing an executable in a commonly trusted directory (ex: under system32) or giving it the name of a legitimate, trusted program (ex: svchost.exe). in containerized environments, this may also be done by creating a resource in a namespace that matches the naming convention of a container pod or cluster. alternatively, a file or container image name given may be a close approximation to legitimate programs/images or something innocuous.",
                    "procedure_description": "strongpity has been bundled with legitimate software installation files for disguise.[127]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                    ...
                    "procedure_description": "strongpity has used encrypted strings in its dropper component.[313][314]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                    ...
                    "technique_name": "subvert trust controls : code signing",
                    "technique_description": "adversaries may create, acquire, or steal code signing materials to sign their malware or tools. code signing provides a level of authenticity on a binary from the developer and a guarantee that the binary has not been tampered with.  the certificates used during an operation may be created, acquired, or stolen by the adversary.   unlike invalid code signature, this activity will result in a valid signature.",
                    "procedure_description": "strongpity has been signed with self-signed certificates.[58]"
                },
                {
                    "tactic_code": "ta0007",
                    ...
                    "procedure_description": "strongpity can parse the hard drive on a compromised host to identify specific file extensions.[288]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "strongpity can determine if a user is logged in by checking to see if explorer.exe is running.[241]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "strongpity can identify if eset or bitdefender antivirus are installed before dropping its payload.[97]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "strongpity can identify the hard disk volume serial number on a compromised host.[355]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "strongpity can identify the ip address of a compromised host.[220]"
                },
                {
                    "tactic_code": "ta0009",
                    ...
                    "procedure_description": "strongpity can compress and encrypt archived files into multiple .sft files with a repeated xor encryption scheme.[40][41]"
                },
                {
                    "tactic_code": "ta0009",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0009",
                    ...
                    "procedure_description": "strongpity has a file searcher component that can automatically collect and archive files based on a predefined list of file extensions.[43]"
                },
                {
                    "tactic_code": "ta0011",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0011",
                    ...
                    "procedure_description": "strongpity can use http and https in c2 communications.[320][321]"
                },
                {
                    "tactic_code": "ta0011",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0011",
                    ...
                    "procedure_description": "strongpity has encrypted c2 traffic using ssl/tls.[56]"
                },
                {
                    "tactic_code": "ta0011",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0011",
                    ...
                    "procedure_description": "strongpity can download files to specified targets.[430]"
                },
                {
                    "tactic_code": "ta0011",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0011",
                    ...
                    "procedure_description": "strongpity has used https over port 1402 in c2 communication.[36]"
                },
                {
                    "tactic_code": "ta0011",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0011",
                    ...
                    "procedure_description": "strongpity can use multiple layers of proxy servers to hide terminal nodes in its infrastructure.[20]"
                },
                {
                    "tactic_code": "ta0010",
                    ...
                    "procedure_description": "strongpity can automatically exfiltrate collected documents to the c2 server.[16][17]"
                },
                {
                    "tactic_code": "ta0010",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0010",
