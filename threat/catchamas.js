var threatdata = {
    ...
    "all_data": {
        ...
        "uuid": "ccea3897-503a-4c12-a7f3-4d721393b1f3",
    ...
    "mitre": [
        ...
        {
            "procedure_name": "catchamas",
            "procedure_code": "s0261",
            "procedure_type": "software",
            "procedure_link": "https://attack.mitre.org/software/S0261",
            "techniques": [
                {
                    "tactic_code": "ta0003",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0003",
                    ...
                    "procedure_description": "catchamas adds a new service named netadapter to establish persistence.[32]"
                },
                {
                    "tactic_code": "ta0004",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0004",
                ...
                },
                {
                    ...
                    "procedure_description": "catchamas adds a new service named netadapter in an apparent attempt to masquerade as a legitimate service.[18]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                    ...
                    "procedure_description": "catchamas creates three registry keys to establish persistence by adding a windows service.[31]"
                },
                {
                    "tactic_code": "ta0006",
                    ...
                    "procedure_description": "catchamas collects keystrokes from the victim\u2019s machine.[36]"
                },
                {
                    "tactic_code": "ta0007",
                    ...
                    "procedure_description": "catchamas obtains application windows titles and then determines which windows to perform screen capture on.[6]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "catchamas gathers the mac address, ip address, and the network adapter information from the victim\u2019s machine.[50]"
                },
                {
                    "tactic_code": "ta0009",
                    ...
                    "procedure_description": "catchamas steals data stored in the clipboard.[15]"
                },
                {
                    "tactic_code": "ta0009",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0009",
                    ...
                    "procedure_description": "catchamas stores the gathered data from the machine in .db files and .bmp files under four separate locations.[20]"
                },
                {
                    "tactic_code": "ta0009",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0009",
