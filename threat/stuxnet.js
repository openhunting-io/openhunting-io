var threatdata = {
    ...
    "all_data": {
        ...
        "alienvault-otx": [
            "https://otx.alienvault.com/browse/pulses?q=tag:Stuxnet"
        ],
        "uuid": "70c4a5b0-2206-4aa0-860f-128288ed2577",
    ...
    "mitre": [
        {
            ...
            "procedure_code": "s0603",
            "procedure_type": "software",
            "procedure_link": "https://attack.mitre.org/software/S0603",
            "techniques": [
                {
                    "tactic_code": "ta0001",
                    ...
                    "procedure_description": "stuxnet can propagate via removable media using an autorun.inf file or the cve-2010-2568 lnk vulnerability.[25]"
                },
                {
                    "tactic_code": "ta0001",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0001",
                    ...
                    "procedure_description": "stuxnet infected wincc machines via a hardcoded database server password.[7]"
                },
                {
                    "tactic_code": "ta0001",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0001",
                    ...
                    "procedure_description": "stuxnet attempts to access network resources with a domain account\u2019s credentials.[22]"
                },
                {
                    "tactic_code": "ta0002",
                    ...
                    "procedure_description": "stuxnet uses the setsecuritydescriptordacl api to reduce object integrity levels.[162]"
                },
                {
                    "tactic_code": "ta0002",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0002",
                    ...
                    "procedure_description": "stuxnet schedules a network job to execute two minutes after host infection.[167]"
                },
                {
                    "tactic_code": "ta0002",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0002",
                    ...
                    "procedure_description": "stuxnet calls loadlibrary then executes exports from a dll.[17]"
                },
                {
                    "tactic_code": "ta0002",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0002",
                    ...
                    "procedure_description": "stuxnet used wmi with an explorer.exe token to execute on a remote share.[122]"
                },
                {
                    "tactic_code": "ta0003",
                    ...
                    "procedure_description": "stuxnet uses a driver registered as a boot start service as the main load-point.[116]"
                },
                {
                    "tactic_code": "ta0003",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0003",
                ...
                },
                {
                    ...
                    "tactic_alias": "persistence",
                    "tactic_description": "The adversary is trying to maintain their foothold.",
                    "technique_code": "t1505.001",
                    "technique_link": "https://attack.mitre.org/techniques/T1505/001",
                    ...
                    "procedure_description": "stuxnet used xp_cmdshell to store and execute sql code.[7]"
                },
                {
                    "tactic_code": "ta0003",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0003",
                ...
                },
                {
                    ...
                    "procedure_description": "stuxnet attempts to impersonate an anonymous token to enumerate bindings in the service control manager.[15]"
                },
                {
                    "tactic_code": "ta0004",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0004",
                ...
                },
                {
                    ...
                    "procedure_description": "stuxnet used ms10-073 and an undisclosed task scheduler vulnerability to escalate privileges on local windows machines.[32]"
                },
                {
                    "tactic_code": "ta0004",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0004",
                    ...
                    "procedure_description": "stuxnet injects an entire dll into an existing, newly created, or preselected trusted process.[65]"
                },
                {
                    "tactic_code": "ta0004",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0004",
                ...
                },
                {
                    ...
                    "procedure_description": "stuxnet decrypts resources that are loaded into memory and executed.[223]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                    ...
                    "procedure_description": "stuxnet checks for specific operating systems on 32-bit machines, registry keys, and dates for vulnerabilities, and will exit execution if the values are not met.[9]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                    ...
                    "procedure_description": "stuxnet reduces the integrity level of objects to allow write actions.[3]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                    ...
                    "procedure_description": "stuxnet can delete ole automation and sql stored procedures used to store malicious payloads.[22]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                    ...
                    "procedure_description": "stuxnet uses an rpc server that contains a routine for file deletion and also removes itself from the system through a dll export by deleting specific files.[229]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                    ...
                    "procedure_description": "stuxnet extracts and writes driver files that match the times of other legitimate files.[50]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                    ...
                    "procedure_description": "stuxnet can create registry keys to load driver files.[152]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                    ...
                    "procedure_description": "stuxnet uses encrypted configuration blocks and writes encrypted files to disk.[315]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                ...
                },
                {
                    ...
                    "procedure_description": "stuxnet uses a windows rootkit to mask its binaries and other relevant files.[24]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                    ...
                    "procedure_description": "stuxnet used a digitally signed driver with a compromised realtek certificate.[66]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                ...
                },
                {
                    ...
                    "procedure_description": "stuxnet enumerates user accounts of the local host.[44]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "stuxnet enumerates user accounts of the domain.[46]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "stuxnet uses a driver to scan for specific filesystem driver objects.[289]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "stuxnet enumerates the directories of a network resource.[54]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "stuxnet enumerates removable drives for infection.[42]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "stuxnet searches the registry for indicators of security programs.[88]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "stuxnet enumerates the currently running processes related to a variety of security products.[98]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "stuxnet collects system information including computer and domain names, os version, and s7p paths.[356]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "stuxnet collects the ip address of a compromised system.[221]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "stuxnet collects the time and date of a system when it is infected.[72]"
                },
                {
                    "tactic_code": "ta0008",
                    ...
                    "procedure_description": "stuxnet propagates using the ms10-061 print spooler and ms08-067 windows server service vulnerabilities.[32]"
                },
                {
                    "tactic_code": "ta0008",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0008",
                    ...
                    "procedure_description": "stuxnet uses an rpc server that contains a file dropping routine and support for payload version updates for p2p communications within a victim network.[28]"
                },
                {
                    "tactic_code": "ta0008",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0008",
                    ...
                    "procedure_description": "stuxnet can propagate via peer-to-peer communication and updates using rpc.[11]"
                },
                {
                    "tactic_code": "ta0008",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0008",
                    ...
                    "procedure_description": "stuxnet propagates to available network shares.[50]"
                },
                {
                    "tactic_code": "ta0008",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0008",
                ...
                },
                {
                    ...
                    "procedure_description": "stuxnet infects remote servers via network shares and by infecting wincc database views with malicious code.[11]"
                },
                {
                    "tactic_code": "ta0009",
                    ...
                    "procedure_description": "stuxnet encrypts exfiltrated data via c2 with static 31-byte long xor keys.[42]"
                },
                {
                    "tactic_code": "ta0011",
                    ...
                    "procedure_description": "stuxnet uses http to communicate with a command and control server. [322]"
                },
                {
                    "tactic_code": "ta0011",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0011",
                    ...
                    "procedure_description": "stuxnet transforms encrypted binary data into an ascii string in order to use it as a url parameter value.[88]"
                },
                {
                    "tactic_code": "ta0011",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0011",
                    ...
                    "procedure_description": "stuxnet encodes the payload of system information sent to the command and control servers using a one byte 0xff xor key. stuxnet also uses a 31-byte long static byte string to xor data sent to command and control servers. the servers use a different static key to encrypt replies to the implant.[129]"
                },
                {
                    "tactic_code": "ta0011",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0011",
                    ...
                    "procedure_description": "stuxnet has the ability to generate new c2 domains.[45]"
                },
                {
                    "tactic_code": "ta0011",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0011",
                    ...
                    "procedure_description": "stuxnet installs an rpc server for p2p communications.[24]"
                },
                {
                    "tactic_code": "ta0010",
                    ...
                    "procedure_description": "stuxnet sends compromised victim information via http.[126]"
                }
            ]
        },
        {
