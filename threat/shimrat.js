var threatdata = {
    ...
    "all_data": {
        ...
        "uuid": "aac889bc-4215-404b-afa4-343364ff8cd4",
    ...
    "mitre": [
        {
            ...
            "procedure_code": "s0444",
            "procedure_type": "software",
            "procedure_link": "https://attack.mitre.org/software/S0444",
            "techniques": [
                {
                    "tactic_code": "ta0002",
                    ...
                    "procedure_description": "shimrat can be issued a command shell function from the c2.[302]"
                },
                {
                    "tactic_code": "ta0002",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0002",
                    ...
                    "procedure_description": "shimrat has used windows api functions to install the service and shim.[153]"
                },
                {
                    "tactic_code": "ta0003",
                    ...
                    "procedure_description": "shimrat has installed a registry based start-up key hkcu\\software\\microsoft\\windows\\currentversion\\run to maintain persistence should other methods fail.[240]"
                },
                {
                    "tactic_code": "ta0003",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0003",
                    ...
                    "procedure_description": "shimrat has installed a windows service to maintain persistence on victim machines.[110]"
                },
                {
                    "tactic_code": "ta0003",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0003",
                    ...
                    "procedure_description": "shimrat has installed shim databases in the apppatch folder.[6]"
                },
                {
                    "tactic_code": "ta0003",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0003",
                    ...
                    "procedure_description": "shimrat can hijack the cryptbase.dll within migwiz.exe to escalate privileges and bypass uac controls.[4]"
                },
                {
                    "tactic_code": "ta0004",
                    ...
                    "procedure_description": "shimrat has hijacked the cryptbase.dll within migwiz.exe to escalate privileges. this prevented the user access control window from appearing.[58]"
                },
                {
                    "tactic_code": "ta0004",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0004",
                ...
                },
                {
                    ...
                    "procedure_description": "shimrat has decompressed its core dll using shellcode once an impersonated antivirus component was running on a system.[212]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                ...
                },
                {
                    ...
                    "procedure_description": "shimrat can uninstall itself from compromised hosts, as well create and modify directories, delete, move, copy, and rename files.[215]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                    ...
                    "procedure_description": "shimrat can impersonate windows services and antivirus products to avoid detection on compromised systems.[66]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                    ...
                    "procedure_description": "shimrat has registered two registry keys for shim databases.[145]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                    ...
                    "procedure_description": "shimrat has been delivered as a package that includes compressed dll and shellcode payloads within a .dat file.[216]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                    ...
                    "procedure_description": "shimrat's loader has been packed with the compressed shimrat core dll and the legitimate dll for it to hijack.[77]"
                },
                {
                    "tactic_code": "ta0007",
                    ...
                    "procedure_description": "shimrat can list directories.[271]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "shimrat can enumerate connected drives for infected host machines.[51]"
                },
                {
                    "tactic_code": "ta0009",
                    ...
                    "procedure_description": "shimrat has the capability to upload collected files to a c2.[168]"
                },
                {
                    "tactic_code": "ta0011",
                    ...
                    "procedure_description": "shimrat communicated over http and https with c2 servers.[300]"
                },
                {
                    "tactic_code": "ta0011",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0011",
                    ...
                    "procedure_description": "shimrat has used a secondary c2 location if the first was unavailable.[42]"
                },
                {
                    "tactic_code": "ta0011",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0011",
                    ...
                    "procedure_description": "shimrat can download additional files.[407]"
                },
                {
                    "tactic_code": "ta0011",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0011",
                    ...
                    "procedure_description": "shimrat can use pre-configured http proxies.[23]"
                },
                {
                    "tactic_code": "ta0010",
                    ...
                    "procedure_description": "shimrat can sleep when instructed to do so by the c2.[16]"
                }
            ]
        },
        {
