var threatdata = {
    ...
    "all_data": {
        ...
        "uuid": "f8f77e1b-9ae1-46a5-9c4f-60894a677b2b",
    ...
    "mitre": [
        ...
        {
            "procedure_name": "fallchill",
            "procedure_code": "s0181",
            "procedure_type": "software",
            "procedure_link": "https://attack.mitre.org/software/S0181",
            "techniques": [
                {
                    "tactic_code": "ta0003",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0003",
                    ...
                    "procedure_description": "fallchill has been installed as a windows service.[8]"
                },
                {
                    "tactic_code": "ta0004",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0004",
                ...
                },
                {
                    ...
                    "procedure_description": "fallchill can delete malware and associated artifacts from the victim.[67]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                    ...
                    "procedure_description": "fallchill can modify file or directory timestamps.[25]"
                },
                {
                    "tactic_code": "ta0007",
                    ...
                    "procedure_description": "fallchill can search files on a victim.[122]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "fallchill can collect operating system (os) version information, processor information, system name, and information about installed disks from the victim.[130]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "fallchill collects mac address and local ip address information from the victim.[85]"
                },
                {
                    "tactic_code": "ta0011",
                    ...
                    "procedure_description": "fallchill uses fake transport layer security (tls) to communicate with its c2 server.[6]"
                },
                {
                    "tactic_code": "ta0011",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0011",
                    ...
                    "procedure_description": "fallchill encrypts c2 data with rc4 encryption.[47][48]"
                }
            ]
        }
    ],
