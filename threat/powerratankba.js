var threatdata = {
    "name": "PowerRatankba",
    "alias": "PowerRatankba, QUICKRIDE.POWER",
    "category": "Malware",
    ...
    "all_data": {
        ...
        "uuid": "4c51ff35-46ff-4228-aed7-7a174600e283",
    ...
    "mitre": [
        {
            ...
            "procedure_code": "s0241",
            "procedure_type": "software",
            "procedure_link": "https://attack.mitre.org/software/S0241",
            "techniques": [
                {
                    "tactic_code": "ta0002",
                    ...
                    "procedure_description": "there is a variant of ratankba that uses a powershell script instead of the traditional pe form.[196][197]"
                },
                {
                    "tactic_code": "ta0002",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0002",
                    ...
                    "procedure_description": "ratankba uses cmd.exe to execute commands.[275][276]"
                },
                {
                    "tactic_code": "ta0002",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0002",
                    ...
                    "procedure_description": "ratankba uses wmi to perform process monitoring.[107][108]"
                },
                {
                    "tactic_code": "ta0004",
                    ...
                    "procedure_description": "ratankba performs a reflective dll injection using a given pid.[59][60]"
                },
                {
                    "tactic_code": "ta0005",
                ...
                },
                {
                    ...
                    "procedure_description": "ratankba uses the net user command.[39]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "ratankba lists the system\u2019s processes.[212][213]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "ratankba uses the command reg query \"hkcu\\software\\microsoft\\windows\\currentversion\\internetsettings\".[75]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "ratankba runs the net view /domain and net view commands.[73]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "ratankba gathers information about the os architecture, os name, and os version/service pack.[296][297]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "ratankba gathers the victim\u2019s ip address via the ipconfig -all command.[193][194]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "ratankba uses netstat -ano to search for specific ip address ranges.[72]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "ratankba runs the whoami and query user commands.[152]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "ratankba uses tasklist /svc to display running tasks.[44]"
                },
                {
                    "tactic_code": "ta0011",
                    ...
                    "procedure_description": "ratankba uses http/https for command and control communication.[268][269]"
                },
                {
                    "tactic_code": "ta0011",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0011",
                    ...
                    "procedure_description": "ratankba uploads and downloads information.[372][373]"
                }
            ]
        },
        {
