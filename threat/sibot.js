    ...
    "mitre": [
        {
            ...
            "procedure_code": "s0589",
            "procedure_type": "software",
            "procedure_link": "https://attack.mitre.org/software/S0589",
            "techniques": [
                {
                    "tactic_code": "ta0002",
                    ...
                    "procedure_description": "sibot executes commands using vbscript.[141]"
                },
                {
                    "tactic_code": "ta0002",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0002",
                    ...
                    "procedure_description": "sibot has been executed via a scheduled task.[73]"
                },
                {
                    "tactic_code": "ta0002",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0002",
                    ...
                    "procedure_description": "sibot has used wmi to discover network connections and configurations. sibot has also used the win32_process class to execute a malicious dll.[116]"
                },
                {
                    "tactic_code": "ta0003",
                ...
                },
                {
                    ...
                    "procedure_description": "sibot can decrypt data received from a c2 and save to a file.[98]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                    ...
                    "procedure_description": "sibot will delete an associated registry key if a certain server response is received.[19]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                    ...
                    "procedure_description": "sibot will delete itself if a certain server response is received.[216]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                    ...
                    "procedure_description": "sibot has downloaded a dll to the c:\\windows\\system32\\drivers\\ folder and renamed it with a .sys extension.[65]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                    ...
                    "procedure_description": "sibot has modified the registry to install a second-stage script in the hkey_local_machine\\software\\microsoft\\windows\\currentversion\\sibot.[146]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                    ...
                    "procedure_description": "sibot has obfuscated scripts used in execution.[77]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                    ...
                    "procedure_description": "sibot has installed a second-stage script in the hkey_local_machine\\software\\microsoft\\windows\\currentversion\\sibot registry key.[30]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                    ...
                    "procedure_description": "sibot has been executed via mshta application.[31]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                    ...
                    "procedure_description": "sibot has executed downloaded dlls with rundll32.exe.[90]"
                },
                {
                    "tactic_code": "ta0007",
                    ...
                    "procedure_description": "sibot has queried the registry for proxy server information.[83]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "sibot checked if the compromised system is configured to use proxies.[93]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "sibot has retrieved a guid associated with a present lan connection on a compromised machine.[79]"
                },
                {
                    "tactic_code": "ta0011",
                    ...
                    "procedure_description": "sibot communicated with its c2 server via http get requests.[143]"
                },
                {
                    "tactic_code": "ta0011",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0011",
                    ...
                    "procedure_description": "sibot can download and execute a payload onto a compromised system.[200]"
                },
                {
                    "tactic_code": "ta0011",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0011",
                    ...
                    "procedure_description": "sibot has used a legitimate compromised website to download dlls to the victim's machine.[31]"
                }
            ]
        }
    ],
