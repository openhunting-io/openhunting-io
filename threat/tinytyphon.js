var threatdata = {
    ...
    "all_data": {
        ...
        "uuid": "05e9fde6-0d47-42c4-a579-d3c5c2e3a87d",
    ...
    "mitre": [
        ...
        {
            "procedure_name": "tinytyphon",
            "procedure_code": "s0131",
            "procedure_type": "software",
            "procedure_link": "https://attack.mitre.org/software/S0131",
            "techniques": [
                {
                    "tactic_code": "ta0003",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0003",
                    ...
                    "procedure_description": "tinytyphon installs itself under registry run key to establish persistence.[40]"
                },
                {
                    "tactic_code": "ta0004",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0004",
                ...
                },
                {
                    ...
                    "procedure_description": "tinytyphon has used xor with 0x90 to obfuscate its configuration file.[333]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "technique_name": "file and directory discovery",
                    "technique_description": "adversaries may enumerate files and directories or may search in specific locations of a host or network share for certain information within a file system. adversaries may use the information from file and directory discovery during automated discovery to shape follow-on behaviors, including whether or not the adversary fully infects the target and/or attempts specific actions.",
                    "procedure_description": "tinytyphon searches through the drive containing the os, then all drive letters c through to z, for documents matching certain extensions.[23]"
                },
                {
                    "tactic_code": "ta0010",
                    ...
                    "procedure_description": "when a document is found matching one of the extensions in the configuration, tinytyphon uploads it to the c2 server.[19]"
                }
            ]
        }
    ],
    "file_name": "tinytyphon",
    "analysis": null,
    "articles": []
};