var threatdata = {
    "name": "FinFisher",
    "alias": "FinFisher, FinFisher RAT, FinSpy",
    "category": "Malware",
    ...
    "all_data": {
        ...
        "alienvault-otx": [
            "https://otx.alienvault.com/browse/pulses?q=tag:finfisher"
        ],
        "uuid": "0475a304-5916-40c5-9b5b-8fce9f52e783",
    ...
    "mitre": [
        ...
        {
            "procedure_name": "finfisher",
            "procedure_code": "s0182",
            "procedure_type": "software",
            "procedure_link": "https://attack.mitre.org/software/S0182",
            "techniques": [
                {
                    "tactic_code": "ta0003",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0003",
                    ...
                    "procedure_description": "finfisher establishes persistence by creating the registry key hkcu\\software\\microsoft\\windows\\run.[95][96]"
                },
                {
                    "tactic_code": "ta0003",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0003",
                    ...
                    "procedure_description": "finfisher creates a new windows service with the malicious executable for persistence.[53][54]"
                },
                {
                    "tactic_code": "ta0003",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0003",
                    ...
                    "procedure_description": "a finfisher variant uses dll search order hijacking.[20][21]"
                },
                {
                    "tactic_code": "ta0003",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0003",
                    ...
                    "procedure_description": "finfisher uses dll side-loading to load malicious programs.[22][23]"
                },
                {
                    "tactic_code": "ta0003",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0003",
                    ...
                    "procedure_description": "finfisher has used the kernelcallbacktable to hijack the execution flow of a process by replacing the __fndword function with the address of a created asynchronous procedure call stub routine.[2]"
                },
                {
                    "tactic_code": "ta0003",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0003",
                    ...
                    "procedure_description": "some finfisher variants incorporate an mbr rootkit.[8][9]"
                },
                {
                    "tactic_code": "ta0004",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0004",
                    ...
                    "procedure_description": "finfisher performs uac bypass.[31][32]"
                },
                {
                    "tactic_code": "ta0004",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0004",
                    ...
                    "procedure_description": "finfisher uses token manipulation with ntfiltertoken as part of uac bypass.[7][8]"
                },
                {
                    "tactic_code": "ta0004",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0004",
                ...
                },
                {
                    ...
                    "procedure_description": "finfisher injects itself into various processes depending on whether it is low integrity or high integrity.[29][30]"
                },
                {
                    "tactic_code": "ta0005",
                ...
                },
                {
                    ...
                    "procedure_description": "finfisher extracts and decrypts stage 3 malware, which is stored in encrypted resources.[88][89]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                ...
                },
                {
                    ...
                    "procedure_description": "finfisher clears the system event logs using  openeventlog/cleareventlog apis .[13][14]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                    ...
                    "procedure_description": "finfisher renames one of its .dll files to uxtheme.dll in an apparent attempt to masquerade as a legitimate file.[57][58]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                    ...
                    "procedure_description": "finfisher is heavily obfuscated in many ways, including through the use of spaghetti code in its functions in an effort to confuse disassembly programs. it also uses a custom xor algorithm to obfuscate code.[123][124]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                    ...
                    "procedure_description": "finfisher contains junk code in its functions in an effort to confuse disassembly programs.[16][17]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                    ...
                    "procedure_description": "a finfisher variant uses a custom packer.[41][42]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                ...
                },
                {
                    ...
                    "procedure_description": "finfisher obtains the hardware device list and checks if the md5 of the vendor id is equal to a predefined list in order to check for sandbox/virtualized environments.[21]"
                },
                {
                    "tactic_code": "ta0006",
                    ...
                    "procedure_description": "finfisher hooks processes by modifying iat pointers to createwindowex.[9][3]"
                },
                {
                    "tactic_code": "ta0007",
                    ...
                    "procedure_description": "finfisher enumerates directories and scans for certain files.[124][125]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "finfisher checks its parent process for indications that it is running in a sandbox setup.[102][103]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "finfisher queries registry values as part of its anti-sandbox checks.[41][42]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "finfisher probes the system to check for antimalware processes.[40][41]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "finfisher checks if the victim os is 32 or 64-bit.[137][138]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
