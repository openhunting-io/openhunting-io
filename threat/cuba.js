var threatdata = {
    ...
    "all_data": {
        ...
        "uuid": "8660efd3-763e-4f56-b8e2-c34b03582591",
        "last-card-change": "2023-09-06",
        "source": "https://apt.etda.or.th/cgi-bin/listtools.cgi"
    },
    "ioc_data": [
        {
            "malware_printable": "Cuba",
            "malware_alias": "COLDDRAW",
            "malware": "win.cuba",
            "last_update": "2021-12-09 01:28:01",
            "tags": [],
            "ioc": {
                "sha256_hash": [
                    {
                        "value": "672fb249e520f4496e72021f887f8bb86fec5604317d8af3f0800d49aa157be1",
                        "timestamp": "2021-12-09 01:28:01"
                    }
                ]
            }
        }
    ...
    "mitre": [
        {
            "procedure_name": "cuba",
            "procedure_code": "s0625",
            "procedure_type": "software",
            "procedure_link": "https://attack.mitre.org/software/S0625",
            "techniques": [
                {
                    "tactic_code": "ta0002",
                    ...
                    "procedure_description": "cuba has been dropped onto systems and used for lateral movement via obfuscated powershell scripts.[69]"
                },
                {
                    "tactic_code": "ta0002",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0002",
                    ...
                    "procedure_description": "cuba has used cmd.exe /c and batch files for execution.[92]"
                },
                {
                    "tactic_code": "ta0002",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0002",
                    ...
                    "procedure_description": "cuba has used several built-in api functions for discovery like getipnettable and netshareenum.[63]"
                },
                {
                    "tactic_code": "ta0003",
                    ...
                    "procedure_description": "cuba can modify services by using the openservice and changeserviceconfig functions.[39]"
                },
                {
                    "tactic_code": "ta0004",
                    ...
                    "procedure_description": "cuba has used sedebugprivilege and adjusttokenprivileges to elevate privileges.[7]"
                },
                {
                    "tactic_code": "ta0004",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0004",
                ...
                },
                {
                    ...
                    "procedure_description": "cuba has executed hidden powershell windows.[14]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                    ...
                    "procedure_description": "cuba can use the command cmd.exe /c del to delete its artifacts from the system.[50]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                    ...
                    "procedure_description": "cuba has been disguised as legitimate 360 total security antivirus and openvpn programs.[42]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                    ...
                    "procedure_description": "cuba has used multiple layers of obfuscation to avoid analysis, including its base64 encoded payload.[90]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                    ...
                    "procedure_description": "cuba has a packed payload when delivered.[27]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                    ...
                    "procedure_description": "cuba loaded the payload into memory using powershell.[10]"
                },
                {
                    "tactic_code": "ta0006",
                    ...
                    "procedure_description": "cuba logs keystrokes via polling by using getkeystate and vkkeyscan functions.[48]"
                },
                {
                    "tactic_code": "ta0007",
                    ...
                    "procedure_description": "cuba can enumerate files by using a variety of functions.[92]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "cuba can discover shared resources using the netshareenum api call.[26]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "cuba can enumerate processes running on a victim's machine.[69]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "cuba can enumerate local drives, disk type, and disk free space.[101]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "cuba can check if russian language is installed on the infected machine by using the function getkeyboardlayoutlist.[9]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "cuba can retrieve the arp cache from the local system by using getipnettable.[65]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "cuba can use the function getipnettable to recover the last connections to the victim's machine.[27]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "cuba can query service status using queryservicestatusex function.[13]"
                },
                {
                    "tactic_code": "ta0009",
                ...
                },
                {
                    ...
                    "procedure_description": "cuba can download files from its c2 server.[131]"
                },
                {
                    "tactic_code": "ta0040",
                    ...
                    "procedure_description": "cuba has the ability to encrypt system data and add the \".cuba\" extension to encrypted files.[39]"
                },
                {
                    "tactic_code": "ta0040",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0040",
