    ...
    "mitre": [
        {
            ...
            "procedure_code": "s0376",
            "procedure_type": "software",
            "procedure_link": "https://attack.mitre.org/software/S0376",
            "techniques": [
                {
                    "tactic_code": "ta0002",
                    ...
                    "procedure_description": "hoplight can launch cmd.exe to execute commands on the system.[160]"
                },
                {
                    "tactic_code": "ta0002",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0002",
                    ...
                    "procedure_description": "hoplight has used svchost.exe to execute a malicious dll .[27]"
                },
                {
                    "tactic_code": "ta0002",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0002",
                    ...
                    "procedure_description": "hoplight has used wmi to recompile the managed object format (mof) files in the wmi repository.[58]"
                },
                {
                    "tactic_code": "ta0004",
                    ...
                    "procedure_description": "hoplight has injected into running processes.[27]"
                },
                {
                    "tactic_code": "ta0005",
                    ...
                    "procedure_description": "hoplight has modified the firewall using netsh.[15]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                    ...
                    "procedure_description": "hoplight has modified managed object format (mof) files within the registry to run specific commands and create persistence on the system.[70]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                ...
                },
                {
                    ...
                    "procedure_description": "hoplight has been observed loading several apis associated with pass the hash.[10]"
                },
                {
                    "tactic_code": "ta0006",
                    ...
                    "procedure_description": "hoplight has the capability to harvest credentials and passwords from the sam database.[11]"
                },
                {
                    "tactic_code": "ta0007",
                    ...
                    "procedure_description": "hoplight can enumerate device drivers located in the registry at hklm\\software\\wbem\\wdm.[7]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "hoplight has been observed enumerating system drives and partitions.[142]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "a variant of hoplight hooks lsass.exe, and lsass.exe then checks the registry for the data value 'rdpproto' under the key system\\currentcontrolset\\control\\lsa name.[47]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "hoplight has been observed collecting victim machine information like os version, volume information, and more.[166]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "hoplight has been observed collecting system time from victim machines.[45]"
                },
                {
                    "tactic_code": "ta0008",
                ...
                },
                {
                    ...
                    "procedure_description": "hoplight has utilized zlib compression to obfuscate the communications payload. [42]"
                },
                {
                    "tactic_code": "ta0011",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0011",
                    ...
                    "procedure_description": "hoplight has multiple c2 channels in place in case one fails.[20]"
                },
                {
                    "tactic_code": "ta0011",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0011",
                    ...
                    "procedure_description": "hoplight has the ability to connect to a remote host in order to upload and download files.[216]"
                },
                {
                    "tactic_code": "ta0011",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0011",
                    ...
                    "procedure_description": "hoplight has connected outbound over tcp port 443 with a faketls method.[18]"
                },
                {
                    "tactic_code": "ta0011",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0011",
                    ...
                    "procedure_description": "hoplight has multiple proxy options that mask traffic between the malware and the remote operators.[21]"
                },
                {
                    "tactic_code": "ta0010",
