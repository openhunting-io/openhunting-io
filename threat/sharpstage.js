var threatdata = {
    ...
    "mitre": [
        {
            "procedure_name": "sharpstage",
            "procedure_code": "s0546",
            "procedure_type": "software",
            "procedure_link": "https://attack.mitre.org/software/S0546",
            "techniques": [
                {
                    "tactic_code": "ta0002",
                    ...
                    "procedure_description": "sharpstage can execute arbitrary commands with powershell.[149][206]"
                },
                {
                    "tactic_code": "ta0002",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0002",
                    ...
                    "procedure_description": "sharpstage can execute arbitrary commands with the command line.[106][107]"
                },
                {
                    "tactic_code": "ta0002",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0002",
                    ...
                    "procedure_description": "sharpstage has a persistence component to write a scheduled task for the payload.[159]"
                },
                {
                    "tactic_code": "ta0002",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0002",
                    ...
                    "procedure_description": "sharpstage can use wmi for execution.[81][115]"
                },
                {
                    "tactic_code": "ta0003",
                    ...
                    "procedure_description": "sharpstage has the ability to create persistence for the malware using the registry autorun key and startup folder.[164]"
                },
                {
                    "tactic_code": "ta0003",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0003",
                ...
                },
                {
                    ...
                    "procedure_description": "sharpstage has decompressed data received from the c2 server.[211]"
                },
                {
                    "tactic_code": "ta0007",
                    ...
                    "procedure_description": "sharpstage has checked the system settings to see if arabic is the configured language.[331]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "sharpstage  has been used to target arabic-speaking users and used code that checks if the compromised machine has the arabic language installed.[11]"
                },
                {
                    "tactic_code": "ta0009",
                    ...
                    "procedure_description": "sharpstage has the ability to capture the victim's screen.[152][153]"
                },
                {
                    "tactic_code": "ta0011",
                    ...
                    "procedure_description": "sharpstage has the ability to download and execute additional payloads via a dropbox api.[153][154]"
                },
                {
                    "tactic_code": "ta0011",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0011",
                    ...
                    "procedure_description": "sharpstage has used a legitimate web service for evading detection.[12]"
                }
            ]
        },
        {
    ...
    "articles": [
        {
            "data_url": "https://www.0ffset.net/reverse-engineering/malware-analysis/molerats-string-decryption/",
            "date": "2021-07-06",
