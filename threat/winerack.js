var threatdata = {
    ...
    "all_data": {
        ...
        "uuid": "c646cc03-d65a-4a5c-9910-82d2789624a7",
    ...
    "mitre": [
        {
            ...
            "procedure_code": "s0219",
            "procedure_type": "software",
            "procedure_link": "https://attack.mitre.org/software/S0219",
            "techniques": [
                {
                    "tactic_code": "ta0002",
                    ...
                    "procedure_description": "winerack can create a reverse shell that utilizes statically-linked wine cmd.exe code to emulate windows command prompt commands.[44]"
                },
                {
                    "tactic_code": "ta0007",
                    ...
                    "procedure_description": "winerack can enumerate active windows.[33]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "winerack can enumerate files and directories.[84]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "winerack can enumerate processes.[200]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "winerack can gather information about the host.[155]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "winerack can gather information on the victim username.[79]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "winerack can enumerate services.[60]"
                }
            ]
        }
    ],
