var threatdata = {
    "name": "NetWalker",
    "alias": "NetWalker, MailTo, Koko Ransomware",
    "category": "Malware",
    ...
    "all_data": {
        ...
        "alienvault-otx": [
            "https://otx.alienvault.com/browse/pulses?q=tag:netwalker"
        ],
        "uuid": "2780e90e-39b2-4609-938b-72c45e2a5e25",
    ...
    "mitre": [
        {
            ...
            "procedure_code": "s0457",
            "procedure_type": "software",
            "procedure_link": "https://attack.mitre.org/software/S0457",
            "techniques": [
                {
                    "tactic_code": "ta0002",
                    ...
                    "procedure_description": "netwalker has been written in powershell and executed directly in memory, avoiding detection.[164][165]"
                },
                {
                    "tactic_code": "ta0002",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0002",
                    ...
                    "procedure_description": "operators deploying netwalker have used batch scripts to retrieve the netwalker payload.[234]"
                },
                {
                    "tactic_code": "ta0002",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0002",
                    ...
                    "procedure_description": "netwalker can use windows api functions to inject the ransomware dll.[127]"
                },
                {
                    "tactic_code": "ta0002",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0002",
                    ...
                    "procedure_description": "operators deploying netwalker have used psexec and certutil to retrieve the netwalker payload.[38]"
                },
                {
                    "tactic_code": "ta0002",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0002",
                    ...
                    "procedure_description": "netwalker can use wmi to delete shadow volumes.[90]"
                },
                {
                    "tactic_code": "ta0004",
                    ...
                    "procedure_description": "the netwalker dll has been injected reflectively into the memory of a legitimate running process.[48]"
                },
                {
                    "tactic_code": "ta0005",
                    ...
                    "procedure_description": "netwalker's powershell script can decode and decrypt multiple layers of obfuscation, leading to the netwalker dll being loaded into memory.[157]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                    ...
                    "procedure_description": "netwalker can detect and terminate active security software-related processes on infected systems.[66][67]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                    ...
                    "procedure_description": "netwalker can add the following registry entry: hkey_current_user\\software{8 random characters}.[103]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                    ...
                    "procedure_description": "netwalker's dll has been embedded within the powershell script in hex format.[13]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                    ...
                    "procedure_description": "netwalker's powershell script has been obfuscated with multiple layers including base64 and hexadecimal encoding and xor-encryption, as well as obfuscated powershell functions and variables.[62][63]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                ...
                },
                {
                    ...
                    "procedure_description": "netwalker can detect and terminate active security software-related processes on infected systems.[73]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "netwalker can determine the system architecture it is running on to choose which version of the dll to use.[250]"
                },
                {
                    "tactic_code": "ta0008",
                    ...
                    "procedure_description": "operators deploying netwalker have used psexec to copy the netwalker payload across accessible systems.[22]"
                },
                {
                    "tactic_code": "ta0011",
                    ...
                    "procedure_description": "operators deploying netwalker have used psexec and certutil to retrieve the netwalker payload.[313]"
                },
                {
                    "tactic_code": "ta0040",
                    ...
                    "procedure_description": "netwalker can encrypt files on infected machines to extort victims.[59]"
                },
                {
                    "tactic_code": "ta0040",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0040",
                    ...
                    "procedure_description": "netwalker can delete the infected system's shadow volumes to prevent recovery.[41][42]"
                },
                {
                    "tactic_code": "ta0040",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0040",
                    ...
                    "procedure_description": "netwalker can terminate system processes and services, some of which relate to backup software.[29]"
                }
            ]
        },
        {
