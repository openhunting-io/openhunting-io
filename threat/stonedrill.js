var threatdata = {
    ...
    "all_data": {
        ...
        "uuid": "3fbd9978-1421-4d34-9a4e-507fd1880629",
    ...
    "mitre": [
        {
            "procedure_name": "stonedrill",
            "procedure_code": "s0380",
            "procedure_type": "software",
            "procedure_link": "https://attack.mitre.org/software/S0380",
            "techniques": [
                {
                    "tactic_code": "ta0002",
                    ...
                    "procedure_description": "stonedrill has several vbs scripts used throughout the malware's lifecycle.[150]"
                },
                {
                    "tactic_code": "ta0002",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0002",
                    ...
                    "procedure_description": "stonedrill has used the wmi command-line (wmic) utility to run tasks.[121]"
                },
                {
                    "tactic_code": "ta0004",
                    ...
                    "procedure_description": "stonedrill has relied on injecting its payload directly into the process memory of the victim's preferred browser.[62]"
                },
                {
                    "tactic_code": "ta0005",
                    ...
                    "procedure_description": "stonedrill has been observed deleting the temporary files once they fulfill their task.[225]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                    ...
                    "procedure_description": "stonedrill has obfuscated its module with an alphabet-based table or xor encryption.[311]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                ...
                },
                {
                    ...
                    "procedure_description": "stonedrill has used several anti-emulation techniques to prevent automated analysis by emulators or sandboxes.[23]"
                },
                {
                    "tactic_code": "ta0007",
                    ...
                    "procedure_description": "stonedrill has looked in the registry to find the default browser path.[87]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "stonedrill can check for antivirus and antimalware programs.[95]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "stonedrill has the capability to discover the system os, windows version, architecture and environment.[352]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                    ...
                    "procedure_description": "stonedrill can obtain the current date and time of the victim machine.[70]"
                },
                {
                    "tactic_code": "ta0007",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0007",
                ...
                },
                {
                    ...
                    "procedure_description": "stonedrill can take screenshots.[162]"
                },
                {
                    "tactic_code": "ta0011",
                    ...
                    "procedure_description": "stonedrill has downloaded and dropped temporary files containing scripts; it additionally has a function to upload files from the victims machine.[428]"
                },
                {
                    "tactic_code": "ta0040",
                    ...
                    "procedure_description": "stonedrill has a disk wiper module that targets files other than those in the windows directory.[4]"
                },
                {
                    "tactic_code": "ta0040",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0040",
                    ...
                    "procedure_description": "stonedrill can wipe the accessible physical or logical drives of the infected machine.[9]"
                },
                {
                    "tactic_code": "ta0040",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0040",
                    ...
                    "procedure_description": "stonedrill can wipe the master boot record of an infected computer.[21]"
                }
            ]
        }
    ],
    "file_name": "stonedrill",
    "analysis": null,
    "articles": [
        {
        ...
        {
            "data_url": "https://www.megabeets.net/decrypting-dropshot-with-radare2-and-cutter-part-2/",
            "date": "2018-06-18",
            "organization": "",
            "author": "Megabeets",
        ...
        {
            "data_url": "https://www.megabeets.net/decrypting-dropshot-with-radare2-and-cutter-part-1/",
            "date": "2018-05-21",
            "organization": "MegaBeets",
            "author": "Itay Cohen",
        ...
        {
            "data_url": "https://media.kasperskycontenthub.com/wp-content/uploads/sites/43/2018/03/07180722/Report_Shamoon_StoneDrill_final.pdf",
            "date": "2017-03-07",
