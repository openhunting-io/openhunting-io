var threatdata = {
    ...
    "mitre": [
        {
            "procedure_name": "costabricks",
            "procedure_code": "s0614",
            "procedure_type": "software",
            "procedure_link": "https://attack.mitre.org/software/S0614",
            "techniques": [
                {
                    "tactic_code": "ta0002",
                    ...
                    "procedure_description": "costabricks has used a number of api calls, including virtualalloc, virtualfree, loadlibrarya, getprocaddress, and exitprocess.[62]"
                },
                {
                    "tactic_code": "ta0004",
                    ...
                    "procedure_description": "costabricks can inject a payload into the memory of a compromised host.[18]"
                },
                {
                    "tactic_code": "ta0005",
                    ...
                    "procedure_description": "costabricks has the ability to use bytecode to decrypt embedded payloads.[64]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                    ...
                    "procedure_description": "costabricks has added the entire unobfuscated code of the legitimate open source application blink to its code.[12]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                    ...
                    "procedure_description": "costabricks can implement a custom-built virtual machine mechanism to obfuscate its code.[25]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                ...
                },
                {
                    ...
                    "procedure_description": "costabricks has been used to load sombrat onto a compromised host.[124]"
                }
            ]
        }
    ],
