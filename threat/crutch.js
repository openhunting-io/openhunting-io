    ...
    "mitre": [
        {
            ...
            "procedure_code": "s0538",
            "procedure_type": "software",
            "procedure_link": "https://attack.mitre.org/software/S0538",
            "techniques": [
                {
                    "tactic_code": "ta0002",
                    ...
                    "procedure_description": "crutch has the ability to persist using scheduled tasks.[47]"
                },
                {
                    "tactic_code": "ta0003",
                    ...
                    "procedure_description": "crutch can persist via dll search order hijacking on google chrome, mozilla firefox, or microsoft onedrive.[16]"
                },
                {
                    "tactic_code": "ta0003",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0003",
                ...
                },
                {
                    ...
                    "procedure_description": "crutch has established persistence with a scheduled task impersonating the outlook item finder.[20]"
                },
                {
                    "tactic_code": "ta0007",
                    ...
                    "procedure_description": "crutch can monitor for removable drives being plugged into the compromised machine.[15]"
                },
                {
                    "tactic_code": "ta0009",
                    ...
                    "procedure_description": "crutch has used the winrar utility to compress and encrypt stolen files.[24]"
                },
                {
                    "tactic_code": "ta0009",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0009",
                    ...
                    "procedure_description": "crutch can automatically monitor removable drives in a loop and copy interesting files.[11]"
                },
                {
                    "tactic_code": "ta0009",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0009",
                    ...
                    "procedure_description": "crutch can exfiltrate files from compromised systems.[52]"
                },
                {
                    "tactic_code": "ta0009",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0009",
                    ...
                    "procedure_description": "crutch can monitor removable drives and exfiltrate files matching a given extension list.[9]"
                },
                {
                    "tactic_code": "ta0009",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0009",
                    ...
                    "procedure_description": "crutch has staged stolen files in the c:\\amd\\temp directory.[24]"
                },
                {
                    "tactic_code": "ta0011",
                    ...
                    "procedure_description": "crutch has conducted c2 communications with a dropbox account using the http api.[84]"
                },
                {
                    "tactic_code": "ta0011",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0011",
                    ...
                    "procedure_description": "crutch has used a hardcoded github repository as a fallback channel.[12]"
                },
                {
                    "tactic_code": "ta0011",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0011",
                    ...
                    "procedure_description": "crutch can use dropbox to receive commands and upload stolen data.[24]"
                },
                {
                    "tactic_code": "ta0010",
                    ...
                    "procedure_description": "crutch has automatically exfiltrated stolen files to dropbox.[3]"
                },
                {
                    "tactic_code": "ta0010",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0010",
                    ...
                    "procedure_description": "crutch can exfiltrate data over the primary c2 channel (dropbox http api).[32]"
                },
                {
                    "tactic_code": "ta0010",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0010",
