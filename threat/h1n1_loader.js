var threatdata = {
    ...
    "all_data": {
        ...
        "alienvault-otx": [
            "https://otx.alienvault.com/browse/pulses?q=tag:H1N1"
        ],
        "uuid": "a33c9005-104b-4553-80c3-1af01a0aba94",
    ...
    "mitre": [
        {
            "procedure_name": "h1n1",
            "procedure_code": "s0132",
            "procedure_type": "software",
            "procedure_link": "https://attack.mitre.org/software/S0132",
            "techniques": [
                {
                    "tactic_code": "ta0001",
                    ...
                    "procedure_description": "h1n1 has functionality to copy itself to removable media.[16]"
                },
                {
                    "tactic_code": "ta0002",
                    ...
                    "procedure_description": "h1n1 kills and disables services by using cmd.exe.[146]"
                },
                {
                    "tactic_code": "ta0004",
                    ...
                    "procedure_description": "h1n1 bypasses user access control by using a dll hijacking vulnerability in the windows update standalone installer (wusa.exe).[35]"
                },
                {
                    "tactic_code": "ta0005",
                ...
                },
                {
                    ...
                    "procedure_description": "h1n1 kills and disables services for windows security center, and windows defender.[40]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                    ...
                    "procedure_description": "h1n1 kills and disables services for windows firewall.[13]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                    ...
                    "procedure_description": "h1n1 uses multiple techniques to obfuscate strings, including xor.[146]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                    ...
                    "procedure_description": "h1n1 uses a custom packing algorithm.[47]"
                },
                {
                    "tactic_code": "ta0006",
                    ...
                    "procedure_description": "h1n1 dumps usernames and passwords from firefox, internet explorer, and outlook.[30]"
                },
                {
                    "tactic_code": "ta0008",
                ...
                },
                {
                    ...
                    "procedure_description": "h1n1 has functionality to copy itself to network shares.[7]"
                },
                {
                    "tactic_code": "ta0011",
                    ...
                    "procedure_description": "h1n1 obfuscates c2 traffic with an altered version of base64.[4]"
                },
                {
                    "tactic_code": "ta0011",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0011",
                    ...
                    "procedure_description": "h1n1 encrypts c2 traffic using an rc4 key.[59]"
                },
                {
                    "tactic_code": "ta0011",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0011",
                    ...
                    "procedure_description": "h1n1 contains a command to download and execute a file from a remotely hosted url using wininet http requests.[207]"
                },
                {
                    "tactic_code": "ta0040",
