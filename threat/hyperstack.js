var threatdata = {
    "name": "HyperStack",
    "alias": "HyperStack, GoldenSky, SilentMoon, Turla SilentMoon, BigBoss, Cacao",
    "category": "Malware",
    "type": "Backdoor",
    "modified": "2022-12-30",
    "all_data": {
        ...
        "uuid": "f1280fc8-feb4-4480-ac03-2ce589fece0a",
    ...
    "mitre": [
        ...
        {
            "procedure_name": "hyperstack",
            "procedure_code": "s0537",
            "procedure_type": "software",
            "procedure_link": "https://attack.mitre.org/software/S0537",
            "techniques": [
                {
                    "tactic_code": "ta0001",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0001",
                    ...
                    "procedure_description": "hyperstack can use default credentials to connect to ipc$ shares on remote machines.[5]"
                },
                {
                    "tactic_code": "ta0002",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0002",
                    ...
                    "procedure_description": "hyperstack can connect to the ipc$ share on remote machines.[4]"
                },
                {
                    "tactic_code": "ta0002",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0002",
                    ...
                    "technique_name": "native api",
                    "technique_description": "adversaries may interact with the native os application programming interface (api) to execute behaviors. native apis provide a controlled means of calling low-level os services within the kernel, such as those involving hardware/devices, memory, and processes. these native apis are leveraged by the os during system boot (when other system components are not yet initialized) as well as carrying out tasks and requests during routine operations.",
                    "procedure_description": "hyperstack can use windows api's connectnamedpipe and wnetaddconnection2 to detect incoming connections and connect to remote shares.[97]"
                },
                {
                    "tactic_code": "ta0003",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0003",
                ...
                },
                {
                    ...
                    "technique_name": "modify registry",
                    "technique_description": "adversaries may interact with the windows registry to hide configuration information within registry keys, remove information as part of cleaning up, or as part of other techniques to aid in persistence and execution.",
                    "procedure_description": "hyperstack can add the name of its communication pipe to hklm\\system\\currentcontrolset\\services\\lanmanserver\\parameters\\nullsessionpipes.[73]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                ...
                },
                {
                    ...
                    "technique_name": "account discovery : local account",
                    "technique_description": "adversaries may attempt to get a listing of local system accounts. this information can help adversaries determine which local accounts exist on a system to aid in follow-on behavior.",
                    "procedure_description": "hyperstack can enumerate all account names on a remote share.[18]"
                },
                {
                    "tactic_code": "ta0011",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0011",
