    ...
    "mitre": [
        {
            ...
            "procedure_code": "s0167",
            "procedure_type": "software",
            "procedure_link": "https://attack.mitre.org/software/S0167",
            "techniques": [
                {
                    "tactic_code": "ta0002",
                    ...
                    "procedure_description": "matryoshka is capable of providing meterpreter shell access.[31]"
                },
                {
                    "tactic_code": "ta0002",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0002",
                    ...
                    "procedure_description": "matryoshka can establish persistence by adding a scheduled task named \"microsoft boost kernel optimization\".[103][104]"
                },
                {
                    "tactic_code": "ta0003",
                    ...
                    "procedure_description": "matryoshka can establish persistence by adding registry run keys.[155][156]"
                },
                {
                    "tactic_code": "ta0003",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0003",
                ...
                },
                {
                    ...
                    "procedure_description": "matryoshka uses reflective dll injection to inject the malicious library and execute the rat.[43]"
                },
                {
                    "tactic_code": "ta0004",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0004",
                ...
                },
                {
                    ...
                    "procedure_description": "matryoshka obfuscates api function names using a substitute cipher combined with base64 encoding.[204]"
                },
                {
                    "tactic_code": "ta0005",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0005",
                ...
                },
                {
                    ...
                    "procedure_description": "matryoshka uses rundll32.exe in a registry run key value for execution as part of its persistence mechanism.[65]"
                },
                {
                    "tactic_code": "ta0006",
                    ...
                    "procedure_description": "matryoshka is capable of stealing outlook passwords.[15][16]"
                },
                {
                    "tactic_code": "ta0006",
                    "tactic_link": "https://attack.mitre.org/tactics/TA0006",
                    ...
                    "procedure_description": "matryoshka is capable of keylogging.[110][111]"
                },
                {
                    "tactic_code": "ta0009",
                ...
                },
                {
                    ...
                    "procedure_description": "matryoshka is capable of performing screen captures.[103][104]"
                },
                {
                    "tactic_code": "ta0011",
                    ...
                    "procedure_description": "matryoshka uses dns for c2.[38][39]"
                }
            ]
        },
        {
